...
public class MultiDBSingleTableDMLTest extends CrudBasedLockTestCase {
    ...
    String createTableSQL = "create table %s (id bigint primary key, a bigint, c int) %s ;";
    ...
    public void initData() throws Exception {
        ...
        JdbcUtil.createDatabase(tddlConnection, dbOneName, "");
        JdbcUtil.createDatabase(tddlConnection, dbTwoName, "");
    }
