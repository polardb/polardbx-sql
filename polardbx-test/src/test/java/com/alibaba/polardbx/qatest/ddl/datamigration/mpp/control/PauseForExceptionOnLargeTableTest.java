package com.alibaba.polardbx.qatest.ddl.datamigration.mpp.control;
...
public class PauseForExceptionOnLargeTableTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(PkTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public PauseForExceptionOnLargeTableTest(boolean crossSchema) {
