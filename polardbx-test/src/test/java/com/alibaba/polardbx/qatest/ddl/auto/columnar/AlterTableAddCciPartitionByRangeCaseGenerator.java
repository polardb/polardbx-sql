...
public class AlterTableAddCciPartitionByRangeCaseGenerator extends CreateCciCaseGeneratorBase {
    private static final String FILE_PREFIX = "test_alter_table_add_cci_partition_by_range";
    ...
    public AlterTableAddCciPartitionByRangeCaseGenerator() {
    ...
    public static void main(String[] args) {
        /*
         cat ./polardbx-test/target/test-classes/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_range.test.yml > ./polardbx-test/src/test/resources/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_range.test.yml && cat ./polardbx-test/target/test-classes/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_range.result > ./polardbx-test/src/test/resources/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_range.result
         */
        final AlterTableAddCciPartitionByRangeCaseGenerator gen =
            new AlterTableAddCciPartitionByRangeCaseGenerator();
        gen.run();
    }
}
