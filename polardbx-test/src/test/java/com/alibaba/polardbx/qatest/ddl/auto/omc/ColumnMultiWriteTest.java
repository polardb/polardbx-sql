...
public class ColumnMultiWriteTest extends DDLBaseNewDBTestCase {
    ...
    public void testColumnMultiWriteInsert() throws SQLException {
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert", " partition by hash(`id`) partitions 7",
            true, false, true, false, INSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert", " partition by hash(`id`) partitions 7",
            false, false, true, false, INSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert", " partition by hash(`id`) partitions 7",
            true, false, true, true, INSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert_brd", " broadcast", true, false, false,
            true, INSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert_single", " single", true, false, false,
            true, INSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert", " partition by hash(`id`) partitions 7",
            false, false, true, true, INSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert_brd", " broadcast", false, false, false,
            true, INSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_insert_single", " single", false, false, false,
            true, INSERT_PARAMS);
    ...
    public void testColumnMultiWriteReplace() throws SQLException {
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace",
            " partition by hash(`id`) partitions 7", false, true, true, false, REPLACE_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace",
            " partition by hash(`id`) partitions 7", true, true, true, false, REPLACE_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace",
            " partition by hash(`id`) partitions 7", false, true, true, true, REPLACE_PARAMS);
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace_brd", " broadcast", false, true, false,
            true, REPLACE_PARAMS);
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace_single", " single", false, true, false,
            true, REPLACE_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace",
            " partition by hash(`id`) partitions 7", true, true, true, true, REPLACE_PARAMS);
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace_brd", " broadcast", true, true, false,
            true, REPLACE_PARAMS);
        testColumnMultiWriteInsertInternal("replace into", "col_mw_test_replace_single", " single", true, true, false,
            true, REPLACE_PARAMS);
    ...
    public void testColumnMultiWriteInsertIgnore() throws SQLException {
        testColumnMultiWriteInsertInternal("insert ignore into", "col_mw_test_replace",
            " partition by hash(`id`) partitions 7", false, true, true, false, REPLACE_PARAMS);
    ...
    public void testColumnMultiWriteUpsert() throws SQLException {
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert", " partition by hash(`id`) partitions 7",
            false, true, true, false, UPSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert", " partition by hash(`id`) partitions 7",
            true, true, true, false, UPSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert", " partition by hash(`id`) partitions 7",
            false, true, true, true, UPSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert_brd", " broadcast", false, true, false,
            true, UPSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert_single", " single", false, true, false,
            true, UPSERT_PARAMS);
        ...
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert", " partition by hash(`id`) partitions 7",
            true, true, true, true, UPSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert_brd", " broadcast", true, true, false,
            true, UPSERT_PARAMS);
        testColumnMultiWriteInsertInternal("insert into", "col_mw_test_upsert_single", " single", true, true, false,
            true, UPSERT_PARAMS);
    ...
    private void testColumnMultiWriteInsertInternal(String op, String tableName, String partitionDef, boolean withPk,
        ...
        if (withGsi) {
            ...
            String createGsiSql1 =
                String.format("create global index %s on %s(a) partition by hash(`a`) partitions 8", gsiName1,
                    tableName);
            String createGsiSql2 =
                String.format("create global index %s on %s(b) partition by hash(`b`) partitions 8", gsiName2,
                    tableName);
            String createGsiSql3 =
                String.format("create global clustered index %s on %s(a) partition by hash(`a`) partitions 8", gsiName3,
                    tableName);
            String createGsiSql4 =
                String.format("create global clustered index %s on %s(b) partition by hash(`b`) partitions 8", gsiName4,
                    tableName);
...
//                checkGsi(tddlConnection, getRealGsiName(tddlConnection, tableName, gsiName4));
    ...
    public void testColumnMultiWriteUpdate() throws SQLException {
        testColumnMultiWriteUpdateInternal("col_mw_test_update", " partition by hash(`id`) partitions 7", "", true,
            false);
        ...
        testColumnMultiWriteUpdateInternal("col_mw_test_update", " partition by hash(`id`) partitions 7", "primary key",
            true, false);
    ...
    private void testColumnMultiWriteUpdateInternal(String tableName, String partitionDef, String primaryDef,
        ...
        String insert = String.format("insert into %s (id,a,b) values (1,2,2),(2,3,3),(3,4,4),(19,20,21)", tableName);
    ...
    public void testColumnMultiWriteInsertSelect() throws SQLException {
        ...
        String createTableSql =
            String.format(
                ...
                tableName);
        String partitionDef = " partition by hash(`id`) partitions 7";
        JdbcUtil.executeUpdateSuccess(tddlConnection, createTableSql + partitionDef);
        JdbcUtil.executeUpdateSuccess(mysqlConnection, createTableSql);
        ...
        String createGsiSql1 =
            String.format("create global clustered index %s on %s(a) partition by hash(`a`) partitions 8", gsiName1,
                tableName);
        String createGsiSql2 =
            String.format("create global index %s on %s(b) partition by hash(`b`) partitions 8", gsiName2, tableName);
        JdbcUtil.executeUpdateSuccess(tddlConnection, createGsiSql1);
//        JdbcUtil.executeUpdateSuccess(tddlConnection, createGsiSql2);
