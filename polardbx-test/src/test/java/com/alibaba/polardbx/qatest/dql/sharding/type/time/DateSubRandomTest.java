...
public class DateSubRandomTest extends TimeTestBase {
    ...
    public DateSubRandomTest(String interval) {
        this.interval = interval;
    }

    private static final String FORMAT_1 = "SELECT DATE_SUB(? ,INTERVAL ? %s)";
     ...
     */
    @Test
    public void testDateSubTime0() {
        String sql = String.format("select concat(date_sub(cast(? as time(0)), interval ? %s))", interval);
     ...
     */
    @Test
    public void testDateSubTime3() {
        String sql = String.format("select concat(date_sub(cast(? as time(3)), interval ? %s))", interval);
     ...
     */
    @Test
    public void testDateSubTime6() {
        String sql = String.format("select concat(date_sub(cast(? as time(6)), interval ? %s))", interval);
     ...
     */
    @Test
    public void testDateSubDatetime0() {
        String sql = String.format("select concat(date_sub(cast(? as datetime(0)), interval ? %s))", interval);
     ...
     */
    @Test
    public void testDateSubDatetime3() {
        String sql = String.format("select concat(date_sub(cast(? as datetime(3)), interval ? %s))", interval);
     ...
     */
    @Test
    public void testDateSubDatetime6() {
        String sql = String.format("select concat(date_sub(cast(? as datetime(6)), interval ? %s))", interval);
    ...
    public void testDateSubDate() {
        String sql = String.format("select concat(date_sub(cast(? as date), interval ? %s))", interval);
