...
public class RenameTableDDLTest extends DDLBaseNewDBTestCase {
    ...
    public void testRenameTable() {
        ...
        sql1 = "create table t1(a varchar(100)) dbpartition by hash(a)";
    ...
    public void testRenamePhyTable() {
        ...
        sql1 =
            "/*+TDDL:cmd_extra(ENABLE_RANDOM_PHY_TABLE_NAME=false)*/create table t3(a varchar(100)) dbpartition by hash(a)";
        JdbcUtil.executeSuccess(tddlConnection, sql1);
