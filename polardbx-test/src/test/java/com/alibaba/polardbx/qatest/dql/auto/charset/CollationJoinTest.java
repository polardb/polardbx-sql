 ...
 * select a.v_utf8mb4_general_ci, b.v_utf8mb4_general_ci
 * from collation_test a
...
public class CollationJoinTest extends CharsetTestBase {
    ...
    public CollationJoinTest(String table, String suffix) {
    ...
    public void testGBK_CHINESE_CI() {
        ...
        testJoin(gbkStrings, COL_GBK_CHINESE_CI, COL_GBK_BIN);
    }
    ...
    public void testGB18030_CHINESE_CI() {
        ...
        testJoin(gbkStrings, COL_GB18030_CHINESE_CI, COL_GB18030_BIN);
    }
    ...
    public void testGB18030_bin() {
        ...
        testJoin(gbkStrings, COL_GB18030_BIN, COL_GB18030_CHINESE_CI);
    }
    ...
    public void testGB18030_UNICODE_520_CI() {
        ...
        testJoin(gbkStrings, COL_GB18030_UNICODE_520_CI, COL_GB18030_BIN);
    }
    ...
    public void testUTF8MB4_GENERAL_CI() {
        ...
        testJoin(utf8Strings, COL_UTF8MB4_GENERAL_CI);
    }
    ...
    public void testUTF8MB4_BIN() {
        ...
        testJoin(utf8Strings, COL_UTF8MB4_BIN, COL_UTF8MB4_GENERAL_CI);
    }
    ...
    public void testUTF8_GENERAL_CI() {
        ...
        testJoin(utf8Strings, COL_UTF8_GENERAL_CI);
        testJoin(utf8Strings, COL_UTF8_GENERAL_CI, COL_UTF8_BIN);
    }
    ...
    public void testUTF8_BIN() {
        ...
        testJoin(utf8Strings, COL_UTF8_BIN);
        testJoin(utf8Strings, COL_UTF8_BIN, COL_UTF8_GENERAL_CI);
    }
    ...
    public void testGBK_BIN() {
        ...
        testJoin(gbkStrings, COL_GBK_BIN);
        testJoin(gbkStrings, COL_GBK_BIN, COL_GBK_CHINESE_CI);
    }
    ...
    public void testUTF16_GENERAL_CI() {
        ...
        testJoin(utf16Strings, COL_UTF16_GENERAL_CI);
        testJoin(utf16Strings, COL_UTF16_GENERAL_CI, COL_UTF16_UNICODE_CI);
    }
    ...
    public void testUTF16_BIN() {
        ...
        testJoin(utf16Strings, COL_UTF16_BIN);
        testJoin(utf16Strings, COL_UTF16_BIN, COL_UTF16_GENERAL_CI);
    }
    ...
    public void testLATIN1_GENERAL_CI() {
        ...
        testJoin(latin1Strings, COL_LATIN1_GENERAL_CI);
    }
    ...
    public void testLATIN1_GENERAL_CS() {
        ...
        testJoin(latin1Strings, COL_LATIN1_GENERAL_CS);
    }
    ...
    public void testLATIN1_BIN() {
        ...
        testJoin(latin1Strings, COL_LATIN1_BIN);
        testJoin(latin1Strings, COL_LATIN1_BIN, COL_LATIN1_GERMAN1_CI);
    }
    ...
    public void testLATIN1_SWEDISH_CS() {
        ...
        testJoin(latin1Strings, COL_LATIN1_SWEDISH_CI);
    }
    ...
    public void testLATIN1_SPANISH_CS() {
        ...
        testJoin(latin1Strings, COL_LATIN1_SPANISH_CI);
    }
    ...
    public void testLATIN1_GERMAN1_CS() {
        ...
        testJoin(latin1Strings, COL_LATIN1_GERMAN1_CI);
        testJoin(latin1Strings, COL_LATIN1_GERMAN1_CI, COL_LATIN1_BIN);
    }
    ...
    public void testLATIN1_DANISH_CS() {
        ...
        testJoin(latin1Strings, COL_LATIN1_DANISH_CI);
        testJoin(latin1Strings, COL_LATIN1_DANISH_CI, COL_LATIN1_BIN);
    }
    ...
    public void testASCII_BIN() {
        ...
        testJoin(asciiStrings, COL_ASCII_BIN);
        testJoin(asciiStrings, COL_ASCII_BIN, COL_ASCII_GENERAL_CI);
    }
    ...
    public void testASCII_GENERAL_CI() {
        ...
        testJoin(asciiStrings, COL_ASCII_GENERAL_CI);
        testJoin(asciiStrings, COL_ASCII_GENERAL_CI, COL_ASCII_BIN);
    }
}
