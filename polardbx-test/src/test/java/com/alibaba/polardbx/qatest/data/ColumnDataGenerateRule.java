 ...
 */
public class ColumnDataGenerateRule {
    ...
    public Byte blob_testRandom() {
        return blobS[pk.intValue() % blobS.length];
    }
    ...
    public BigDecimal decimal_testRandom() {
        return bigDecimalS[pk.intValue() % bigDecimalS.length];
    }
    ...
    public Double double_testRandom() {
        return doubleS[pk.intValue() % doubleS.length];
    }
    ...
    public Float float_testRandom() {
        return floatS[pk.intValue() % floatS.length];
    }
    ...
    public String varchar_testRandom() {
        return StringS[pk.intValue() % StringS.length];
    }
    ...
    public String date_testRandom() {
        return dateS[pk.intValue() % dateS.length];
    }
