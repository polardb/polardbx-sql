...
public class SubTimeRandomTest extends TimeTestBase {
    ...
    public SubTimeRandomTest(String fsp) {
        this.fsp = fsp;
    }

    @Test
    public void testRandomDatetime() {
        String format = "select concat(subtime(cast(? as datetime(%s)), cast(? as time(%s))))";
    ...
    public void testRandomTime() {
        String format = "select concat(subtime(cast(? as time(%s)), cast(? as time(%s))))";
    ...
    public void testRandomDate() {
        String format = "select concat(subtime(cast(? as date), cast(? as time(%s))))";
