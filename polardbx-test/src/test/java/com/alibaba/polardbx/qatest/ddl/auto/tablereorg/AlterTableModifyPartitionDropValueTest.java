...
@NotThreadSafe
public class AlterTableModifyPartitionDropValueTest extends AlterTableReorgBaseTest {
    ...
    public AlterTableModifyPartitionDropValueTest(PartitionRuleInfo partitionRuleInfo) {
