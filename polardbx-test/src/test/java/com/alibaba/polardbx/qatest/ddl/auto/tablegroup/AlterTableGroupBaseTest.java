 ...
 * @author luoyanxin
 */
public class AlterTableGroupBaseTest extends DDLBaseNewDBTestCase {
    ...
    public AlterTableGroupBaseTest(String logicalDatabase, List<String> finalTableStatus) {
    ...
    public void setUp(boolean recreateDB, PartitionRuleInfo partitionRuleInfo, boolean withConcurrentDml) {
        ...
        if (withConcurrentDml) {
            dmlWhilePartitionReorg(partitionRuleInfo, partitionRuleInfo.alterTableGroupCommand, "t2");
        } else {
            executePartReorg(partitionRuleInfo.tableStatus, partitionRuleInfo.physicalTableBackfillParallel,
                partitionRuleInfo.alterTableGroupCommand);
        }
    }
    ...
    public void setUpForMovePart(boolean recreateDB, PartitionRuleInfo partitionRuleInfo) {
        ...
        String command = String.format("%s'%s'", partitionRuleInfo.alterTableGroupCommand, targetInstId);
    ...
    static class PartitionRuleInfo {
        ...
        public void prepareData(String tableName, Integer insertRow) {
            switch (initDataType) {
            case 1:
                AlterTableGroupBaseTest.initData1(tableName, insertRow, connection);
                break;
            case 2:
                AlterTableGroupBaseTest.initData2(tableName, insertRow, connection);
                break;
            case 3:
                AlterTableGroupBaseTest.initData3(tableName, insertRow, connection);
                break;
            case 4:
                AlterTableGroupBaseTest.initData4(tableName, insertRow, connection);
                break;
            default:
        ...
        void prepareDml(String logicalDatabase) {
            ...
            switch (dmlType) {
            case 1:
                AlterTableGroupBaseTest.initDML1("t1", rowCount, targetPart, partCol, partVals, logicalDatabase,
                    connection);
                break;
            case 2:
                AlterTableGroupBaseTest.initDML2("t1", rowCount, targetPart, partCol, partVals, logicalDatabase,
                    connection);
                break;
            case 3:
                AlterTableGroupBaseTest.initDML3("t1", rowCount, targetPart, partCol, partVals, logicalDatabase,
                    connection);
                break;
            case 4:
                AlterTableGroupBaseTest.initDML4("t1", rowCount, targetPart, partCol, partVals, logicalDatabase,
                    connection);
                break;
            case 5:
                AlterTableGroupBaseTest.initDML5(rowCount, minVal1, maxVal1, partCol, partVals);
                break;
            case 6:
                AlterTableGroupBaseTest.initDML6(rowCount, minVal1, maxVal1, minVal2, maxVal2,
                    partCol,
                    partVals);
                break;
            case 7:
                AlterTableGroupBaseTest.initDML7(rowCount, minVal1, maxVal1, partCol, partVals);
                break;
            default:
                assert false;
            }
