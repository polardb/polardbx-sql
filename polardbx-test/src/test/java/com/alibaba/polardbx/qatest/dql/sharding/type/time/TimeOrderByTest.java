...
/**
 * datetime_0 ~ datetime_6
 * time_0 ~ time_6
 * date_0 ~ date_6
 */

public class TimeOrderByTest extends TimeTableTestBase {
    private String fsp;
    ...
    public TimeOrderByTest(String fsp) {
        super(randomTableName("time_o_fsp_test", 4));
        this.fsp = fsp;
    }
