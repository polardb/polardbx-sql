...
public class AlterTableGroupModifyPartitionAddValueTest extends AlterTableGroupBaseTest {
    ...
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(new PartitionRuleInfo(PartitionStrategy.LIST,
                ...
                "alter tablegroup " + tableGroupName + " modify partition p2 add values(10001, 10002)"),
            new PartitionRuleInfo(PartitionStrategy.LIST_COLUMNS,
                4,
                PARTITION_BY_INT_BIGINT_LIST,
                "alter tablegroup " + tableGroupName + " modify partition p2 add values((2,100011),(2,100011))"))
    );
    ...
    public AlterTableGroupModifyPartitionAddValueTest(PartitionRuleInfo partitionRuleInfo) {
