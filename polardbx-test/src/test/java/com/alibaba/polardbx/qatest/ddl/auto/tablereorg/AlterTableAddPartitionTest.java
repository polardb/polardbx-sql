...
@NotThreadSafe
public class AlterTableAddPartitionTest extends AlterTableReorgBaseTest {
    ...
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(
            new PartitionRuleInfo(PartitionStrategy.RANGE,
                ...
                "alter table " + tableName + " add partition (partition p9 values less than(100400))"),
            new PartitionRuleInfo(PartitionStrategy.RANGE_COLUMNS,
                2,
                PARTITION_BY_INT_BIGINT_RANGE_COL,
                "alter table " + tableName + " add partition (partition p9 values less than(400, 100400))"),
    ...
    final static String logicalDatabase = "AlterTableAddPartition";

    public AlterTableAddPartitionTest(PartitionRuleInfo partitionRuleInfo) {
