...
public class FullTypeSeparatedTestUtil {
    public static String TABLE_DEFINITION_FORMAT = "CREATE TABLE `%s` (\n" +
    ...
    public static ImmutableMap<String, String> allColumnDefinitions = ImmutableMap.<String, String>builder()
