...
public class CreateCciPartitionByHashCaseGenerator extends CreateCciCaseGeneratorBase {
    private static final String FILE_PREFIX = "test_create_cci_partition_by_hash";
    ...
    public CreateCciPartitionByHashCaseGenerator() {
    ...
    public static void main(String[] args) {
        /*
         cat ./polardbx-test/target/test-classes/partition/env/CreateCciTest/test_create_cci_partition_by_hash.test.yml > ./polardbx-test/src/test/resources/partition/env/CreateCciTest/test_create_cci_partition_by_hash.test.yml && cat ./polardbx-test/target/test-classes/partition/env/CreateCciTest/test_create_cci_partition_by_hash.result > ./polardbx-test/src/test/resources/partition/env/CreateCciTest/test_create_cci_partition_by_hash.result
         */
        final CreateCciPartitionByHashCaseGenerator gen = new CreateCciPartitionByHashCaseGenerator();
        gen.run();
    }
}
