...
public class PartitionColumnTypeForListColumns2Test extends PartitionColumnTypeTestBase {

    public TestParameter parameter;

    public PartitionColumnTypeForListColumns2Test(TestParameter parameter) {
        super(parameter);
        this.testDbName = this.testDbName + "_l2";
