...
public class RepartitionTest extends PartitionAutoLoadSqlTestBase {

    private String targetStorage = null;
    private String substitute = "$dn1";

    public RepartitionTest(AutoLoadSqlTestCaseParams parameter) {
        super(parameter);
    ...
    public static List<AutoLoadSqlTestCaseParams> parameters() {
        ...
        return getParameters(RepartitionTest.class, 0, false);
    }
