package com.alibaba.polardbx.qatest.ddl.datamigration.mpp.mirrorcopy;
...
public class PauseAndContinueOnLargeTableTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(PkTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public PauseAndContinueOnLargeTableTest(boolean crossSchema) {
