...
@NotThreadSafe
public class AlterTableGroupMoveSubPartTemplateTest extends AlterTableGroupSubPartitionTest {

    public AlterTableGroupMoveSubPartTemplateTest(PartitionRuleInfo partitionRuleInfo) {
    ...
    protected static List<PartitionRuleInfo> getPartitionRuleInfos(String alterPrefix) {
        ...
        String moveSubPartition = alterPrefix + " move subpartitions p2sp1,p2sp2 to '%s'";
