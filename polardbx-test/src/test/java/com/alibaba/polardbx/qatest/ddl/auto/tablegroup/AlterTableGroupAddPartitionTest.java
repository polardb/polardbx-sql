...
@NotThreadSafe
public class AlterTableGroupAddPartitionTest extends AlterTableGroupTestBase {
    ...
    static List<PartitionRuleInfo> partitionRuleInfos = Arrays.asList(
    ...
    final static String logicalDatabase = "AlterTableGroupAddPartitionTest";
