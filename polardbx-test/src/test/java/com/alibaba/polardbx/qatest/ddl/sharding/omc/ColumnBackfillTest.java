...
public class ColumnBackfillTest extends DDLBaseNewDBTestCase {
    ...
    private static final String GSI_TMPL = "create global clustered index {0} on {1}(id) dbpartition by hash(id)";
    ...
    public void backfillTestInternal(String tableName, String tableTmpl, boolean fillNull, boolean withGsi)
        ...
        final String createTableSql = MessageFormat.format(tableTmpl, tableName);
