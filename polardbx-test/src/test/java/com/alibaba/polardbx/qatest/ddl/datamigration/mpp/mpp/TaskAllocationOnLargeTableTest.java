package com.alibaba.polardbx.qatest.ddl.datamigration.mpp.mpp;
...
public class TaskAllocationOnLargeTableTest extends DDLBaseNewDBTestCase {

    final static Log log = LogFactory.getLog(PkTest.class);
    private String tableName = "";
    private static final String createOption = " if not exists ";

    public TaskAllocationOnLargeTableTest(boolean crossSchema) {
    ...
    public void testPauseAndContinueForLargeTable2() throws Exception {
        ...
        pkRangeTestParam.setMppTaskAllocationCheck(true);
