...
public class SpecialUpdateTest2 extends AutoCrudBasedLockTestCase {
     ...
     */
    @Test
    public void updateMultiTableWithCompositePK() {
        ...
        for (int i = 0; i < 10; i++) {
            params.add(Lists.newArrayList(i, 10, "x"));
        }
        ...
        params.clear();
        for (int i = 0; i < 10; i++) {
            params.add(Lists.newArrayList(i, 10, "t"));
        }
        executeBatchOnMysqlAndTddl(mysqlConnection, tddlConnection, insertSql, params);
