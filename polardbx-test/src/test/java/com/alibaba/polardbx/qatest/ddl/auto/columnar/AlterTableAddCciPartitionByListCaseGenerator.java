...
public class AlterTableAddCciPartitionByListCaseGenerator extends CreateCciCaseGeneratorBase {
    private static final String FILE_PREFIX = "test_alter_table_add_cci_partition_by_list";
    ...
    public AlterTableAddCciPartitionByListCaseGenerator() {
    ...
    public static void main(String[] args) {
        /*
         cat ./polardbx-test/target/test-classes/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_list.test.yml > ./polardbx-test/src/test/resources/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_list.test.yml && cat ./polardbx-test/target/test-classes/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_list.result > ./polardbx-test/src/test/resources/partition/env/AlterTableAddCciTest/test_alter_table_add_cci_partition_by_list.result
         */
        final AlterTableAddCciPartitionByListCaseGenerator gen = new AlterTableAddCciPartitionByListCaseGenerator();
        gen.run();
    }
}
