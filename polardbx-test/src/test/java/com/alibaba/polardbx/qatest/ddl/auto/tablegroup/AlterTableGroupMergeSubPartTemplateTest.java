...
@NotThreadSafe
public class AlterTableGroupMergeSubPartTemplateTest extends AlterTableGroupSubPartitionTest {
    ...
    private static final String MERGE_PHY_PARTITION_GROUP = alterTableGroup + " merge subpartitions sp2,sp1 to sp2";
    private static final String MERGE_PHY_PARTITION = alterTable + " merge subpartitions sp2,sp1 to sp2";

    public AlterTableGroupMergeSubPartTemplateTest(PartitionRuleInfo partitionRuleInfo) {
