...
public class CreateTableWithSequenceTest extends BaseSequenceTestCase {
    private Log log = LogFactory.getLog(CreateTableWithSequenceTest.class);
    ...
    public CreateTableWithSequenceTest(String seqType, String sqlPostFix, String schema) {
...
//        Assert.assertTrue(isIDSame(sql, "ID", new Integer[] { 1, 2, 5, 6, 7 }));
    ...
    public void testInsertInMultiThread() throws Exception {
        ...
        if (isSpecialSequence(seqType) || TStringUtil.isBlank(sqlPostFix)) {
            assertThat(
