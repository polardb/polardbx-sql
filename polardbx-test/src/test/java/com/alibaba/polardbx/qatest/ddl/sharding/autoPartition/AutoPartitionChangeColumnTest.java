...
public class AutoPartitionChangeColumnTest extends AutoPartitionTestBase {
    private static final String HINT = "/*+TDDL:cmd_extra(ALLOW_LOOSE_ALTER_COLUMN_WITH_GSI=true)*/";
    private String TABLE_NAME = "auto_partition_chg_col_tb";
    private String CGSI_NAME = "cg_i_ap_chg_col";
    private String UCGSI_NAME = "cug_i_ap_chg_col";
    private static final String CREATE_TABLE = "CREATE PARTITION TABLE `{0}` (\n"
        ...
        + ");";
    private static final String CREATE_TABLE_NO_PK = "CREATE PARTITION TABLE `{0}` (\n"
        + "  `i0` int,\n"
        + "  `i1` int,\n"
        + "  `c0` varchar(20),\n"
        + "  `c1` varchar(20),\n"
    ...
    public static List<String[]> prepareDate() {
        return ImmutableList.of(new String[] {CREATE_TABLE},
            new String[] {CREATE_TABLE_NO_PK});
    }
    ...
    public AutoPartitionChangeColumnTest(String createTable) {
        this.TABLE_NAME = randomTableName(TABLE_NAME, 4);
        this.CGSI_NAME = randomTableName(CGSI_NAME, 4);
        this.UCGSI_NAME = randomTableName(UCGSI_NAME, 4);
        this.createTableStmt = MessageFormat.format(createTable, TABLE_NAME, CGSI_NAME, UCGSI_NAME);
        this.hasPk = createTableStmt.contains("PRIMARY KEY");
        selectGSI0 =
    ...
    public void changeColumnRenameTest() throws Exception {
        ...
        selectContentSameAssert(selectGSI0, selectPrimary, null, tddlConnection, tddlConnection);
        selectContentSameAssert(selectGSI1, selectPrimary, null, tddlConnection, tddlConnection);
