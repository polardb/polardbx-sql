...
public class TestNamedDdlTask extends AbstractDdlTask implements Comparable<DdlTask> {

    public TestNamedDdlTask(long taskId, String taskName) {
        super(taskName);
        this.taskId = taskId;
    }
    ...
    @Override
    public int compareTo(DdlTask o) {
