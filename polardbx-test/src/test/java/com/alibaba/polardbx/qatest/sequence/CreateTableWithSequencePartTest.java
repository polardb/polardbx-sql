...
public class CreateTableWithSequencePartTest extends BaseSequenceTestCase {
    private Log log = LogFactory.getLog(CreateTableWithSequencePartTest.class);
    ...
    public CreateTableWithSequencePartTest(String seqType, String sqlPostFix, String schema) {
    ...
    public void testCreateTableNormal() throws Exception {
        String sequencePostfix = RandomUtils.getStringBetween(5, 10);
        String tableName = schemaPrefix + sequencePostfix;
        String seqName = schemaPrefix + "AUTO_SEQ_" + sequencePostfix;
        ...
        //判断show create table (commented out in AUTO mode)
        if (!usingNewPartDb()) {
...
//    @Ignore("预期结果不确定,暂时忽略")
    ...
    public void testInsertSelect() throws Exception {
        String sequencePostfix = RandomUtils.getStringBetween(5, 10);
        String srcTablePostfix = RandomUtils.getStringBetween(5, 10);
        String tableName = schemaPrefix + sequencePostfix;
        String srcTableName = schemaPrefix + srcTablePostfix;
        dropTableIfExists(tableName);
