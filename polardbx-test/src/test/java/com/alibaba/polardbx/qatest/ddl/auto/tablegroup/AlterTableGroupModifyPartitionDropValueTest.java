...
@NotThreadSafe
public class AlterTableGroupModifyPartitionDropValueTest extends AlterTableGroupBaseTest {
    ...
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(new PartitionRuleInfo(PartitionStrategy.LIST,
                ...
                "alter tablegroup " + tableGroupName + " modify partition p2 drop values(100010, 100011)"),
            new PartitionRuleInfo(PartitionStrategy.LIST_COLUMNS,
                4,
                PARTITION_BY_INT_BIGINT_LIST,
                "alter tablegroup " + tableGroupName + " modify partition p2 drop values((1,100011),(1,100012))"))
    );

    private static PartitionRuleInfo partitionRuleInfo;
    private static boolean firstIn = true;
    final static String logicalDatabase = "AlterTableGroupDropValueTest";

    public AlterTableGroupModifyPartitionDropValueTest(PartitionRuleInfo partitionRuleInfo) {
