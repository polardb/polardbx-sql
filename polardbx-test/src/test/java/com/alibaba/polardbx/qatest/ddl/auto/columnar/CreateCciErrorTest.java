...
public class CreateCciErrorTest extends DDLBaseNewDBTestCase {

    private static final String PRIMARY_TABLE_NAME1 = "create_cci_err_prim_pt_1";
    private static final String INDEX_NAME1 = "create_cci_err_cci_pt_1";
    private static final String PRIMARY_TABLE_NAME2 = "create_cci_err_prim_pt_2";
    private static final String INDEX_NAME2 = "create_cci_err_cci_pt_2";
    private static final String PRIMARY_TABLE_NAME3 = "create_cci_err_prim_pt_3";
    private static final String INDEX_NAME3 = "create_cci_err_cci_pt_3";
    ...
    public void testCreate1_error_duplicate_index_name() {
        ...
        try {
            ...
            final String createCciTmpl = "CREATE CLUSTERED COLUMNAR INDEX %s ON %s(`buyer_id`) PARTITION BY KEY(`ID`)";
            ...
            // Create cci success
            final String sqlCreateCci1 = String.format(createCciTmpl, cciTestIndexName1, cciTestTableName1);
            ...
            final String sqlCreateCci2 = String.format(createCciTmpl, cciTestIndexName1, cciTestTableName2);
            createCciSuccess(sqlCreateCci2);

            // Duplicated cci name(conflict with name of another table)
            final String sqlCreateCci3 = String.format(createCciTmpl, cciTestTableName1, cciTestTableName3);
            ...
            final String sqlCreateCci4 = String.format(createCciTmpl, cciTestIndexName1, cciTestTableName1);
            createCciWithErr(
                sqlCreateCci4,
                String.format("Duplicate index name '%s'", cciTestIndexName1));
        } catch (Exception e) {
    ...
    public void testCreate2_error_duplicated_column_name() {
        ...
        try {
            ...
            final String sqlCreateIndex1 = String.format(
                "CREATE CLUSTERED COLUMNAR INDEX %s ON %s(`buyer_id`, buyer_id) PARTITION BY KEY(`id`)",
                cciTestIndexName1,
                cciTestTableName1);
            ...
            final String sqlCreateIndex2 = String.format(
                "CREATE CLUSTERED COLUMNAR INDEX %s ON %s(`buyer_id`) COVERING(`buyer_id`) PARTITION BY KEY(`id`)",
                cciTestIndexName1,
                cciTestTableName1);
            ...
            final String sqlCreateIndex3 = String.format(
                "CREATE CLUSTERED COLUMNAR INDEX %s ON %s(`buyer_id`) COVERING(`order_snapshot`, `order_snapshot`) PARTITION BY KEY(`id`)",
                cciTestIndexName1,
                cciTestTableName1);
    ...
    public void testCreate3_error_not_clustered() {
        ...
        final String sqlCreateIndex1 = String.format(
            "CREATE COLUMNAR INDEX %s ON %s(`buyer_id`) PARTITION BY KEY(`id`)",
            cciTestIndexName1,
            cciTestTableName1);
