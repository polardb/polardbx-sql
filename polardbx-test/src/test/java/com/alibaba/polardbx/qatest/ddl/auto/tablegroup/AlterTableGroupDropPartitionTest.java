...
@NotThreadSafe
public class AlterTableGroupDropPartitionTest extends AlterTableGroupBaseTest {
    ...
    static List<PartitionRuleInfo> partitionRuleInfos = new ArrayList<>(Arrays
        .asList(new PartitionRuleInfo(PartitionStrategy.RANGE,
                1,
                PARTITION_BY_BIGINT_RANGE, "alter tablegroup " + tableGroupName + " drop partition p2"),
            new PartitionRuleInfo(PartitionStrategy.RANGE_COLUMNS,
                2,
                PARTITION_BY_INT_BIGINT_RANGE_COL, "alter tablegroup " + tableGroupName + " drop partition p2"),
            new PartitionRuleInfo(PartitionStrategy.LIST,
                1,
                PARTITION_BY_BIGINT_LIST, "alter tablegroup " + tableGroupName + " drop partition p2"),
            new PartitionRuleInfo(PartitionStrategy.LIST_COLUMNS,
                4,
                PARTITION_BY_INT_BIGINT_LIST, "alter tablegroup " + tableGroupName + " drop partition p2"))
    );

    private static PartitionRuleInfo partitionRuleInfo;
    static boolean firstIn = true;
    final static String logicalDatabase = "AlterTableGroupDropPartitionTest";

    public AlterTableGroupDropPartitionTest(PartitionRuleInfo partitionRuleInfo) {
