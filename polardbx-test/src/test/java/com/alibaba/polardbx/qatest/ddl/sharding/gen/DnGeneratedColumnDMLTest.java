...
public class DnGeneratedColumnDMLTest extends DDLBaseNewDBTestCase {
    ...
    private static final String[] PART_DEFS =
        {"dbpartition by hash(a)", "single", "broadcast"};
    ...
    private static final String[][] UPSERT_PARAMS = new String[][] {
        ...
        new String[] {
            ...
            + "on duplicate key update id=values(id)+10", "(id,a)",
            "values (100,101) on duplicate key update id=id+10"},
        new String[] {
            "(id,a)", "values (101,102),(102,103) on duplicate key update id=id+10",
            "(id,a)", "values (101,102),(102,103) on duplicate key update id=id+10"}
    };
    ...
    private void testGeneratedColumnDmlInternal(String tableName, boolean withGsi, boolean withData, String[] dml,
        ...
        if (withGsi) {
            ...
            String createGsi3 =
                String.format("create global index %s on %s(id) covering(c) dbpartition by hash(id)", gsiName3,
                    tableName);
