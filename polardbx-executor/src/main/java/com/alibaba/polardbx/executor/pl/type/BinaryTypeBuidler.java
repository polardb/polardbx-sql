...
public class BinaryTypeBuidler extends AbstractBasicSqlTypeBuilder {
    public static BinaryTypeBuidler INSTANCE = new BinaryTypeBuidler();

    private BinaryTypeBuidler() {
    }
