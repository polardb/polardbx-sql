 ...
 **/
@TaskName(name = "CdcCreateJavaFunctionMarkTask")
@Getter
@Setter
public class CdcCreateJavaFunctionMarkTask extends BaseDdlTask {

    private final String functionName;

    @JSONCreator
    public CdcCreateJavaFunctionMarkTask(String schemaName, String functionName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        CdcManagerHelper.getInstance()
            .notifyDdlNew(
                schemaName,
                functionName,
                SqlKind.CREATE_JAVA_FUNCTION.name(),
