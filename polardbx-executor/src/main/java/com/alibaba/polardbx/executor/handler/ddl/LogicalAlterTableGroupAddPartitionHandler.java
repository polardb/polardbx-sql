...
public class LogicalAlterTableGroupAddPartitionHandler extends LogicalCommonDdlHandler {

    public LogicalAlterTableGroupAddPartitionHandler(IRepository repo) {
        super(repo);
    }
    ...
    protected DdlJob buildDdlJob(BaseDdlOperation logicalDdlPlan, ExecutionContext executionContext) {
        ...
        logicalAlterTableGroupAddPatition.preparedData();
