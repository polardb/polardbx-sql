...
public class Long2DecimalSum extends LittleNum2DecimalSum {
    public Long2DecimalSum(int targetIndexes, boolean distinct, DataType inputType, DataType outputType,
                           int filterArg) {
