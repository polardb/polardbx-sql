...
@ExpressionSignatures(names = {"BitAnd", "&"}, argumentTypes = {"Long", "ULong"}, argumentKinds = {Variable, Const})
public class BitAndLongColULongConstVectorizedExpression extends AbstractVectorizedExpression {
    private final boolean rightIsNull;
    private final long right;

    public BitAndLongColULongConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
        ...
        if (rightValue == null) {
            ...
            rightIsNull = false;
            right = ((UInt64) rightValue).longValue();
        }
    }
