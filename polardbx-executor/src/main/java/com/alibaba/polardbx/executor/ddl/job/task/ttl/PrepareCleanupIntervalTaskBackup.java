 ...
 */
@Getter
@TaskName(name = "PrepareCleanupIntervalTaskBackup")
public class PrepareCleanupIntervalTaskBackup extends AbstractTtlJobTask {
    ...
    @JSONCreator
    public PrepareCleanupIntervalTaskBackup(String schemaName,
...
//            long arcCciTblDataLength = 0;
//            if (needPerformArchivingByOssTbl) {
//                // Fetch the arc-tmp tbl data-length
//                arcCciTblDataLength = TtlJobUtil.fetchArcCciTableDataLength(ec, this.jobContext, null);
//            }
//            this.jobContext.setArcTmpDataLengthBeforeRunning(arcCciTblDataLength);
            ...
            this.jobContext.setCurrentDateTimeFormatedByArcPartUnit(formatedCurrentDatetime);
...
//        final IServerConfigManager serverConfigManager = TtlJobUtil.getServerConfigManager();
//        final String ttlTblSchemaName = this.jobContext.getTtlInfo().getTtlInfoRecord().getTableSchema();
//        TtlArchiveKind archiveKind = TtlArchiveKind.of(this.jobContext.getTtlInfo().getTtlInfoRecord().getArcKind());
//
//        TtlDefinitionInfo ttlInfo = this.jobContext.getTtlInfo();
//        String ttlTimezoneStr = ttlInfo.getTtlInfoRecord().getTtlTimezone();
//        String charsetEncoding = TtlConfigUtil.getDefaultCharsetEncodingOnTransConn();
...
//         *
//         */
//        FetchExpiredDataUpperBoundTask fetchBoundTask = new FetchExpiredDataUpperBoundTask(this, ec, this.jobContext);
//        fetchBoundTask.fetchCurrDatetimeAndExpiredUpperBound(serverConfigManager, ttlTblSchemaName, sessionVariables);
//
//        this.jobContext.setCurrentDateTime(fetchBoundTask.getCurrentDatetime());
//        this.jobContext.setFormatedCurrentDateTime(fetchBoundTask.getFormatedCurrentDatetime());
//        this.jobContext.setCleanUpUpperBound(fetchBoundTask.getExpiredUpperBound());
//    }
