 ...
 **/
@TaskName(name = "CdcCreateFunctionMarkTask")
@Getter
@Setter
public class CdcCreateFunctionMarkTask extends BaseDdlTask {

    private final String functionName;

    @JSONCreator
    public CdcCreateFunctionMarkTask(String schemaName, String functionName) {
        super(schemaName);
