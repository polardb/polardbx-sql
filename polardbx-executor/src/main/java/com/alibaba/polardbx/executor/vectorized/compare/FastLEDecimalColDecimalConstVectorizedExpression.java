...
public class FastLEDecimalColDecimalConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastLEDecimalColDecimalConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
