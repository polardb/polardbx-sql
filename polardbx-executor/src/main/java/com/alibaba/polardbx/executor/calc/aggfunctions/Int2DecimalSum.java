...
public class Int2DecimalSum extends LittleNum2DecimalSum {
    public Int2DecimalSum(int targetIndexes, boolean distinct, DataType inputType, DataType outputType, int filterArg) {
