...
public class FastLTDecimalColDecimalConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastLTDecimalColDecimalConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
