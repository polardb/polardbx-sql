 ...
 * @author guxu
 */
public class LogicalPauseScheduleHandler extends HandlerCommon {

    private static final Logger logger = LoggerFactory.getLogger(LogicalPauseScheduleHandler.class);

    public LogicalPauseScheduleHandler(IRepository repo) {
        super(repo);
    }

    @Override
    public Cursor handle(RelNode logicalPlan, ExecutionContext executionContext) {
        SqlPauseSchedule pauseSchedule = (SqlPauseSchedule) ((LogicalDal) logicalPlan).getNativeSqlNode();
