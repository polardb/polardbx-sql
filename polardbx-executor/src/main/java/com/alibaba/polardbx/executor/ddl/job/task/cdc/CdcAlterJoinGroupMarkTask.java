 ...
 **/
@TaskName(name = "CdcAlterJoinGroupMarkTask")
@Getter
@Setter
public class CdcAlterJoinGroupMarkTask extends BaseDdlTask {

    private final String joinGroupName;

    @JSONCreator
    public CdcAlterJoinGroupMarkTask(String schemaName, String joinGroupName) {
        super(schemaName);
