...
public class OptimizerAlertScheduleSyncAction implements ISyncAction {

    public OptimizerAlertScheduleSyncAction() {
    }

    @Override
    public ResultCursor sync() {
        ArrayResultCursor result = new ArrayResultCursor("OptimizerAlertSchedule");
        ...
        result.initMeta();
        List<Pair<OptimizerAlertType, Long>> collects = OptimizerAlertManager.getInstance().collectByScheduleJob();
