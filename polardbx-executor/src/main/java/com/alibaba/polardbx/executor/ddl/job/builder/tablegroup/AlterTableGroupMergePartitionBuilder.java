...
public class AlterTableGroupMergePartitionBuilder extends AlterTableGroupBaseBuilder {

    public AlterTableGroupMergePartitionBuilder(DDL ddl, AlterTableGroupMergePartitionPreparedData preparedData,
                                                ExecutionContext executionContext) {
        super(ddl, preparedData, executionContext);
    }

    protected void generateNewPhysicalTableNames(List<String> allLogicalTableNames) {
        AlterTableGroupMergePartitionPreparedData mergeData = (AlterTableGroupMergePartitionPreparedData) preparedData;
        if (mergeData.isMergeSubPartition() || mergeData.isUseTemplatePart()) {
            ...
            if (mergeData.isUseTemplatePart()) {
