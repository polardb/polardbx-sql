...
import com.alibaba.polardbx.executor.ddl.job.factory.ttl.AlterTableRemoveTtlJobFactory;
 ...
 * @author chenghui.lch
 */
public class LogicalAlterTableRemoveTtlHandler extends LogicalCommonDdlHandler {

    public LogicalAlterTableRemoveTtlHandler(IRepository repo) {
        super(repo);
    }
    ...
    public DdlJob buildDdlJob(BaseDdlOperation logicalDdlPlan, ExecutionContext executionContext) {
        ...
        AlterTableRemoveTtlJobFactory jobFactory =
            new AlterTableRemoveTtlJobFactory(schemaName, primaryTableName,
