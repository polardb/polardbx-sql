...
@TaskName(name = "CdcAlterProcedureMarkTask")
@Getter
@Setter
public class CdcAlterProcedureMarkTask extends BaseDdlTask {

    private final String procedureName;

    @JSONCreator
    public CdcAlterProcedureMarkTask(String schemaName, String procedureName) {
        super(schemaName);
