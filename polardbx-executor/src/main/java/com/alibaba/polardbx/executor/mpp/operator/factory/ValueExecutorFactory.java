...
import com.alibaba.polardbx.executor.operator.ValueExec;
...
public class ValueExecutorFactory extends ExecutorFactory {

    private LogicalValues logicalValues;

    public ValueExecutorFactory(LogicalValues logicalValues) {
