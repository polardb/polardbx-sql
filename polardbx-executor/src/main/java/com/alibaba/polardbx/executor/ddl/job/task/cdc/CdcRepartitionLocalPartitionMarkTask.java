 ...
 **/
@TaskName(name = "CdcRepartitionLocalPartitionMarkTask")
@Getter
@Setter
public class CdcRepartitionLocalPartitionMarkTask extends BaseDdlTask {

    private final String tableName;

    @JSONCreator
    public CdcRepartitionLocalPartitionMarkTask(String schemaName, String tableName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        CdcManagerHelper.getInstance()
            .notifyDdlNew(
                schemaName,
                tableName,
                SqlKind.REPARTITION_LOCAL_PARTITION.name(),
