...
/**
 * make sure everything is okay before actually executing DDL
 */
public abstract class BaseValidateTask extends BaseDdlTask {

    public BaseValidateTask(String schemaName) {
        super(schemaName);
