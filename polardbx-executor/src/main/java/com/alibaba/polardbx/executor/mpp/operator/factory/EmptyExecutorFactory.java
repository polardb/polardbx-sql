...
public class EmptyExecutorFactory extends ExecutorFactory {

    private final List<DataType> columnMetaList;

    public EmptyExecutorFactory(List<DataType> columnMetaList) {
