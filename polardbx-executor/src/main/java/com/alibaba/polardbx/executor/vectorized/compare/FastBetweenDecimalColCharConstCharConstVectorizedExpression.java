...
@ExpressionSignatures(
    ...
    argumentTypes = {"Decimal", "Char", "Char"},
    argumentKinds = {Variable, Const, Const},
    priority = ExpressionPriority.SPECIAL
)
public class FastBetweenDecimalColCharConstCharConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastBetweenDecimalColCharConstCharConstVectorizedExpression(
        ...
        if (operand1Value == null) {
            ...
            this.operand1 = DataTypes.DecimalType.convertFrom(operand1Value);
        }
        if (operand2Value == null) {
            ...
            this.operand2 = DataTypes.DecimalType.convertFrom(operand2Value);
        }
