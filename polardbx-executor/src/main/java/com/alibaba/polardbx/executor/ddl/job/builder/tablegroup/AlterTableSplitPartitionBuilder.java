...
public class AlterTableSplitPartitionBuilder extends AlterTableGroupSplitPartitionBuilder {

    public AlterTableSplitPartitionBuilder(DDL ddl, AlterTableGroupSplitPartitionPreparedData preparedData,
