...
public class LogicalAlterTableRepartitionLocalPartitionHandler extends LogicalCommonDdlHandler {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(LogicalAlterTableRepartitionLocalPartitionHandler.class);
    ...
    public DdlJob buildDdlJob(BaseDdlOperation logicalDdlPlan, ExecutionContext executionContext) {
        ...
        SqlAlterTableRepartitionLocalPartition sqlAllocateLocalPartition =
            (SqlAlterTableRepartitionLocalPartition) sqlAlterTable;
