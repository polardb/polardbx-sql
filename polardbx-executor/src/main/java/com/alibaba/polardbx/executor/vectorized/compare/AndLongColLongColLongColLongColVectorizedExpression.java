...
@ExpressionSignatures(names = {"AND"}, argumentTypes = {"Long", "Long", "Long", "Long"}, argumentKinds = {Variable, Variable, Variable, Variable})
public class AndLongColLongColLongColLongColVectorizedExpression extends AbstractVectorizedExpression {
    public AndLongColLongColLongColLongColVectorizedExpression(
        int outputIndex,
