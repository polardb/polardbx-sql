 ...
 */
public class InspectSeqRangeSyncAction implements ISyncAction {

    private String seqName;
    private String schemaName;

    public InspectSeqRangeSyncAction() {

    }

    public InspectSeqRangeSyncAction(String schemaName, String seqName) {
