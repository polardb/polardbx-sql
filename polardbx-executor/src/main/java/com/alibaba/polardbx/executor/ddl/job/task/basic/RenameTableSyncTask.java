...
@Getter
@TaskName(name = "RenameTableSyncTask")
public class RenameTableSyncTask extends BaseSyncTask {

    private final String logicalTableName;
    private final String newLogicalTableName;

    @JSONCreator
    public RenameTableSyncTask(String schemaName, String logicalTableName, String newLogicalTableName) {
        super(schemaName);
