...
public class FastGEDecimalColLongConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastGEDecimalColLongConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
