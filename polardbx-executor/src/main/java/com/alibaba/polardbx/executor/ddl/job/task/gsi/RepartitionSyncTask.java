...
@TaskName(name = "RepartitionSyncTask")
@Getter
public class RepartitionSyncTask extends BaseSyncTask {

    final String primaryTableName;
    final String indexName;

    @JSONCreator
    public RepartitionSyncTask(String schemaName,
    ...
    protected void executeImpl(ExecutionContext executionContext) {
        ...
        try {
            ...
            SyncManagerHelper.sync(
                new RepartitionSyncAction(schemaName,
                    primaryTableName,
                    indexName,
            ...
            String errMsg = String.format(
                "error occurs while sync gsi meta during cutover, tableName:%s, gsiName:%s",
                primaryTableName, indexName
            );
            LOGGER.error(errMsg);
