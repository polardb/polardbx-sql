...
public class BlobBlockBuilder extends ReferenceBlockBuilder<Blob> {
    ...
    @Override
    public Block build() {
        return new BlobBlock(0, getPositionCount(), mayHaveNull() ? valueIsNull.elements() : null, values.elements());
    }
    ...
    public void writeObject(Object value) {
        ...
        Preconditions.checkArgument(value instanceof Blob);
    ...
    public BlockBuilder newBlockBuilder() {
        return new BlobBlockBuilder(getCapacity());
    }
}
