...
public class FastLEDecimalColLongConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastLEDecimalColLongConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
