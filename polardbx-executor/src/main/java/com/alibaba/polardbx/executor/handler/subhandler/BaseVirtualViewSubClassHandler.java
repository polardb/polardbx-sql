 ...
 * @author shengyu
 */
abstract public class BaseVirtualViewSubClassHandler {
    /**
     * the source virtualView Handler
     */
    VirtualViewHandler virtualViewHandler;

    public BaseVirtualViewSubClassHandler(VirtualViewHandler virtualViewHandler) {
        this.virtualViewHandler = virtualViewHandler;
    }

    /**
     * @return true if the handler support the virtualView
     */
     ...
     */
    public abstract Cursor handle(VirtualView virtualView,
