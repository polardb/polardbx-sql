...
public class OSSBackFillLoader extends Loader {
    ...
    protected OSSBackFillLoader(String schemaName, String tableName, SqlInsert insert, SqlInsert insertIgnore,
    ...
    public static Loader create(String schemaName, String primaryTable, String indexTable,
        ...
        return new OSSBackFillLoader(schemaName,
            indexTable,
            sqlInsert,
            sqlInsertIgnore,
            checkerPlan,
            ...
            checkerParamMapping,
            executeFunc,
            sourceTargetGroupMap, designateLogicalPart);
    }
