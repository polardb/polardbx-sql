...
public class InEmptyListVectorizedExpression extends AbstractVectorizedExpression {
    public InEmptyListVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
