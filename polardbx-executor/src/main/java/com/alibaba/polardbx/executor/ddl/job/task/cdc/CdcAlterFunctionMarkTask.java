 ...
 **/
@TaskName(name = "CdcAlterFunctionMarkTask")
@Getter
@Setter
public class CdcAlterFunctionMarkTask extends BaseDdlTask {

    private final String functionName;

    @JSONCreator
    public CdcAlterFunctionMarkTask(String schemaName, String functionName) {
        super(schemaName);
