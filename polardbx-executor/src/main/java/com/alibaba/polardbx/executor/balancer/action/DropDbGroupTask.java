 ...
 * @since 2021/08
 */
@TaskName(name = "DropDbGroupTask")
@Getter
public class DropDbGroupTask extends BaseDdlTask {

    private final static Logger LOG = SQLRecorderLogger.ddlEngineLogger;
    private final String groupName;

    @JSONCreator
    public DropDbGroupTask(String schemaName, String groupName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        for (TableGroupConfig tg : tgm.getTableGroupConfigInfoCache().values()) {
        ...
        DbTopologyManager.cleanPhyDbOfRemovingDbGroup(schemaName, groupName, metaDbConnection, -1);
