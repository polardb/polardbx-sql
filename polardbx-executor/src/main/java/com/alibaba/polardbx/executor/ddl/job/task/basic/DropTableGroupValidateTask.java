...
@Getter
@TaskName(name = "DropTableGroupValidateTask")
public class DropTableGroupValidateTask extends BaseValidateTask {

    private String tableGroupName;

    @JSONCreator
    public DropTableGroupValidateTask(String schemaName,
