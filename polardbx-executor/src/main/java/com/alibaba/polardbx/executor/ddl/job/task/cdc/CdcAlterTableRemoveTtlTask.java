 ...
 *
 */
@TaskName(name = "CdcAlterTableRemoveTtlTask")
@Getter
@Setter
public class CdcAlterTableRemoveTtlTask extends BaseDdlTask {
    private final String tableName;

    @JSONCreator
    public CdcAlterTableRemoveTtlTask(String schemaName, String tableName) {
        super(schemaName);
