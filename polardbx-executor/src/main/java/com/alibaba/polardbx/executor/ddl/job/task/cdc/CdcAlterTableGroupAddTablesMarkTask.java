 ...
 **/
@TaskName(name = "CdcAlterTableGroupAddTablesMarkTask")
@Getter
@Setter
public class CdcAlterTableGroupAddTablesMarkTask extends BaseDdlTask {

    private final String tableGroupName;

    @JSONCreator
    public CdcAlterTableGroupAddTablesMarkTask(String schemaName, String tableGroupName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        CdcManagerHelper.getInstance()
            .notifyDdlNew(
                schemaName,
                tableGroupName,
                SqlKind.ALTER_TABLEGROUP_ADD_TABLE.name(),
