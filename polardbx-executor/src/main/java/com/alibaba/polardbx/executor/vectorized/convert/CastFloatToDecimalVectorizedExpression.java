...
@ExpressionSignatures(names = {"CastToDecimal", "ConvertToDecimal"}, argumentTypes = {"Float"},
    argumentKinds = {Variable})
public class CastFloatToDecimalVectorizedExpression extends AbstractVectorizedExpression {

    public CastFloatToDecimalVectorizedExpression(DataType<?> outputDataType, int outputIndex,
    ...
    public void eval(EvaluationContext ctx) {
        ...
        float[] input = inputVectorSlot.cast(FloatBlock.class).floatArray();
