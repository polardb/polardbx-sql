...
public class BufferResult {
    ...
    private final List<SerializedChunk> serializedPages;

    public BufferResult(String taskInstanceId, long token, long nextToken, boolean bufferComplete,
                        List<SerializedChunk> serializedPages) {
    ...
    public List<SerializedChunk> getSerializedPages() {
    ...
    public int hashCode() {
        int hash = 1;
        hash = hash * 31 + Long.hashCode(token);
        hash = hash * 31 + Long.hashCode(nextToken);
        hash = hash * 31 + taskInstanceId.hashCode();
        hash = hash * 31 + Boolean.hashCode(bufferComplete);
        hash = hash * 31 + serializedPages.hashCode();
        return hash;
