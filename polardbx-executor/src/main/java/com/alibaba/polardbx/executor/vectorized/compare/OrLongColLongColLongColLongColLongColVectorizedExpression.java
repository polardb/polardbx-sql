...
@ExpressionSignatures(names = {"OR"}, argumentTypes = {"Long", "Long", "Long", "Long", "Long"},
    argumentKinds = {Variable, Variable, Variable, Variable, Variable})
public class OrLongColLongColLongColLongColLongColVectorizedExpression extends AbstractVectorizedExpression {
    public OrLongColLongColLongColLongColLongColVectorizedExpression(
        int outputIndex,
