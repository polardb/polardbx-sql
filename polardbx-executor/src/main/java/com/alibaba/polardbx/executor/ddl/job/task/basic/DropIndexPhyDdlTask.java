...
@TaskName(name = "DropIndexPhyDdlTask")
public class DropIndexPhyDdlTask extends BasePhyDdlTask {

    @JSONCreator
    public DropIndexPhyDdlTask(String schemaName, PhysicalPlanData physicalPlanData) {
    ...
    public void executeImpl(ExecutionContext executionContext) {
        try {
            ...
            if (successCount == 0) {
                ...
                // Forbid CANCEL DDL command if part of physical DDLs failed.
