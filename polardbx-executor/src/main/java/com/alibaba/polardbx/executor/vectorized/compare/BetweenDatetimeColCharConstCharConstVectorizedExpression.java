...
@ExpressionSignatures(names = {"BETWEEN ASYMMETRIC"}, argumentTypes = {"Datetime", "Char", "Char"},
    argumentKinds = {Variable, Const, Const})
public class BetweenDatetimeColCharConstCharConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public BetweenDatetimeColCharConstCharConstVectorizedExpression(
        int outputIndex,
