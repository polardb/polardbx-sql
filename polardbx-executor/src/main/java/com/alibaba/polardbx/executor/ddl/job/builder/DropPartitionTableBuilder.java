...
public class DropPartitionTableBuilder extends DropTableBuilder {

    private final DropTablePreparedData preparedData;

    public DropPartitionTableBuilder(DDL ddl, DropTablePreparedData preparedData, ExecutionContext executionContext) {
    ...
    public static DropTableBuilder createBuilder(String schemaName,
        ...
        return new DropPartitionTableBuilder(dropTable, logicalDropTable.getDropTablePreparedData(), executionContext);
    }

    @Override
    public DropTableBuilder build() {
