 ...
 **/
@TaskName(name = "CdcDropJavaFunctionMarkTask")
@Getter
@Setter
public class CdcDropJavaFunctionMarkTask extends BaseDdlTask {

    private final String functionName;

    @JSONCreator
    public CdcDropJavaFunctionMarkTask(String schemaName, String functionName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        CdcManagerHelper.getInstance()
            .notifyDdlNew(
                schemaName,
                functionName,
                SqlKind.DROP_JAVA_FUNCTION.name(),
