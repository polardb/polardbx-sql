...
@Getter
@TaskName(name = "CreateFunctionRegisterMetaTask")
public class CreateFunctionRegisterMetaTask extends BaseGmsTask {
    private final String createFunctionContent;
    protected final String functionName;

    @JSONCreator
    public CreateFunctionRegisterMetaTask(String schemaName, String logicalTableName,
                                          String functionName, String createFunctionContent) {
    ...
    protected void executeImpl(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        accessor.insertFunction(functionName, createFunctionContent, executionContext);

        PlParameterAccessor plParameterAccessor = new PlParameterAccessor();
        plParameterAccessor.setConnection(metaDbConnection);
        plParameterAccessor.insertFunctionParams(functionName, createFunctionContent);
    }
