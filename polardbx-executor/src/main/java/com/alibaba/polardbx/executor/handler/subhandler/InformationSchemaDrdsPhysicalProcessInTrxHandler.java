 ...
 * @author shengyu
 */
public class InformationSchemaDrdsPhysicalProcessInTrxHandler extends BaseVirtualViewSubClassHandler {

    public InformationSchemaDrdsPhysicalProcessInTrxHandler(VirtualViewHandler virtualViewHandler) {
        super(virtualViewHandler);
    }

    @Override
    public boolean isSupport(VirtualView virtualView) {
        return virtualView instanceof InformationSchemaDrdsPhysicalProcessInTrx;
    }
