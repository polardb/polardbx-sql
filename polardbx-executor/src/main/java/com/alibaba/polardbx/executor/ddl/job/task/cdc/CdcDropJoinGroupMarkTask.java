 ...
 **/
@TaskName(name = "CdcDropJoinGroupMarkTask")
@Getter
@Setter
public class CdcDropJoinGroupMarkTask extends BaseDdlTask {

    private final String joinGroupName;

    @JSONCreator
    public CdcDropJoinGroupMarkTask(String schemaName, String joinGroupName) {
        super(schemaName);
