...
import com.alibaba.polardbx.optimizer.view.InformationSchemaAutoSplitSchedule;
 ...
 * @author guxu
 */
public class InformationSchemaAutoSplitScheduleHandler extends BaseVirtualViewSubClassHandler {
    public InformationSchemaAutoSplitScheduleHandler(VirtualViewHandler virtualViewHandler) {
        super(virtualViewHandler);
    }

    @Override
    public boolean isSupport(VirtualView virtualView) {
        return virtualView instanceof InformationSchemaAutoSplitSchedule;
    }
    ...
    public Cursor handle(VirtualView virtualView, ExecutionContext executionContext, ArrayResultCursor cursor) {
        ...
        for (ScheduledJobsRecord rs : recordList) {
            ...
            if (!ScheduledJobExecutorType.AUTO_SPLIT_TABLE_GROUP.name().equalsIgnoreCase(rs.getExecutorType())) {
                continue;
            }
            ...
            cursor.addRow(new Object[] {
                rs.getScheduleId(),
                rs.getTableSchema(),
                rs.getTableGroupName(),
                rs.getStatus(),
                rs.getScheduleExpr(),
                rs.getExecutorContents(),
