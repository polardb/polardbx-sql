...
public class Decimal2DecimalAvg extends SpecificType2DecimalAvg {
    public Decimal2DecimalAvg(int index, boolean isDistict, DataType inputType, DataType outputType, int filterArg) {
