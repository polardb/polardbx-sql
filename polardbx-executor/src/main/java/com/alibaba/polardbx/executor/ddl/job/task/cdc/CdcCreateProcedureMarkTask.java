 ...
 **/
@TaskName(name = "CdcCreateProcedureMarkTask")
@Getter
@Setter
public class CdcCreateProcedureMarkTask extends BaseDdlTask {

    private final String procedureName;

    @JSONCreator
    public CdcCreateProcedureMarkTask(String schemaName, String procedureName) {
        super(schemaName);
