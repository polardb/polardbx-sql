 ...
 **/
@TaskName(name = "CdcAllocateLocalPartitionMarkTask")
@Getter
@Setter
public class CdcAllocateLocalPartitionMarkTask extends BaseDdlTask {

    private final String tableName;

    @JSONCreator
    public CdcAllocateLocalPartitionMarkTask(String schemaName, String tableName) {
        super(schemaName);
    ...
    protected void duringTransaction(Connection metaDbConnection, ExecutionContext executionContext) {
        ...
        CdcManagerHelper.getInstance()
            .notifyDdlNew(
                schemaName,
                tableName,
                SqlKind.ALLOCATE_LOCAL_PARTITION.name(),
