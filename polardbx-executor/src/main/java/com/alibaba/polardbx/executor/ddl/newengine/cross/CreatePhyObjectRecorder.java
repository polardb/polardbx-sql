 ...
 * @author wumu
 */
public class CreatePhyObjectRecorder extends GenericPhyObjectRecorder {
    public CreatePhyObjectRecorder(RelNode physicalPlan, ExecutionContext executionContext) {
