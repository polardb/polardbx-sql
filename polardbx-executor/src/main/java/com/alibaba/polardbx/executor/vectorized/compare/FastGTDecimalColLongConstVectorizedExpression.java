...
public class FastGTDecimalColLongConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastGTDecimalColLongConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
