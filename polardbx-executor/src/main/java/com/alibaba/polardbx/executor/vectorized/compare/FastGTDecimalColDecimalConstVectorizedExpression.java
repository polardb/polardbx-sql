...
public class FastGTDecimalColDecimalConstVectorizedExpression extends AbstractVectorizedExpression {
    ...
    public FastGTDecimalColDecimalConstVectorizedExpression(int outputIndex, VectorizedExpression[] children) {
