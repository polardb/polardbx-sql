...
@Getter
@TaskName(name = "DropPartitionTableRemoveMetaTask")
public class DropPartitionTableRemoveMetaTask extends BaseGmsTask {

    @JSONCreator
    public DropPartitionTableRemoveMetaTask(String schemaName, String logicalTableName) {
