...
@Data
public class ExecutableDdlJob4TruncateTableWithGsiCutOver extends ExecutableDdlJob {
    private CdcTruncateTableWithGsiMarkTask cdcMarkTask;
    private TruncateSyncTask truncateSyncTask;
}
