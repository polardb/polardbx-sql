...
public class BetweenTimestampColCharConstCharConstVectorizedExpressionTest {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, String left, String right, int[] sel) {
        ...
        BetweenTimestampColCharConstCharConstVectorizedExpression condition =
            new BetweenTimestampColCharConstCharConstVectorizedExpression(
                3,
                new VectorizedExpression[] {
                    new InputRefVectorizedExpression(DataTypes.TimestampType, 0, 0),
        ...
        MutableChunk preAllocatedChunk = MutableChunk.newBuilder(context.getExecutorChunkLimit())
            .addEmptySlots(Collections.singletonList(DataTypes.TimestampType))
