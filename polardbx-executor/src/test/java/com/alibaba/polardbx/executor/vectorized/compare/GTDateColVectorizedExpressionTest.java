...
public class GTDateColVectorizedExpressionTest {
    ...
    public void testDateDate() {
        ...
        LongBlock expectBlock = LongBlock.of(null, 0L, 1L, 0L, 1L, 0L, 1L, 0L, 1L, null);
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        GTDateColDateColVectorizedExpression condition =
            new GTDateColDateColVectorizedExpression(
                3,
