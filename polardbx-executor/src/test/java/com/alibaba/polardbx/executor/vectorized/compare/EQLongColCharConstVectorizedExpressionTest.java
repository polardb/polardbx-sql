...
public class EQLongColCharConstVectorizedExpressionTest {
    ...
    public void testNull() {
        ...
        LongBlock longBlock = LongBlock.of(1L, 2L, 100L, null, 200L, 1000L, null, 100L, 0L);
        Chunk inputChunk = new Chunk(longBlock.getPositionCount(), longBlock);
    ...
    private void doTestNull(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        ...
        EQLongColCharConstVectorizedExpression condition = new EQLongColCharConstVectorizedExpression(
            2,
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, String value, int[] sel) {
        ...
        // rex node is "=(bigint ref, char const)"
        RexNode rexNode = REX_BUILDER.makeCall(
            ...
            ImmutableList.of(
                ...
                REX_BUILDER.makeLiteral(value, TYPE_FACTORY.createSqlType(SqlTypeName.VARCHAR), true)
            ));
        ...
        condition.getChildren()[1] = new LiteralVectorizedExpression(DataTypes.VarcharType, null, 0);
