...
public class InExpressionParamRewriterWithRawStringTest {
    ...
    public void setUpDynamicExpression() {
        ...
        Mockito.when(dynamicParamExpression.eval(any(), any())).thenReturn(ImmutableList.of(111, 222, 333, 444, 555));
    }
    ...
    public void setupCall() {
        ...
        RexDynamicParam rexDynamicParam = REX_BUILDER.makeDynamicParam(
        ...
        RexCall rexNode2 = (RexCall) REX_BUILDER.makeCall(
            ...
            ImmutableList.of(rexDynamicParam)
        );
    ...
    public void test() {
        ...
        Assert.assertEquals(
            "{2={test_phy_table2=[222], test_phy_table1=[111], test_phy_table4=[444], test_phy_table3=[333], test_phy_table5=[555]}}",
            result.toString());
    }
