...
public class BetweenDateColCharConstVectorizedExpressionTest {
    ...
    public void testDate() {
        DateBlockBuilder dateBlockBuilder = new DateBlockBuilder(count, DataTypes.DateType, context);
        for (MysqlDateTime mysqlDateTime : dateList) {
            if (mysqlDateTime == null) {
                dateBlockBuilder.appendNull();
            } else {
                dateBlockBuilder.writeMysqlDatetime(mysqlDateTime);
            }
        }
        DateBlock dateBlock = (DateBlock) dateBlockBuilder.build();
    ...
    @Test
    public void testDateWithSelection() {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, String left, String right, int[] sel) {
        ...
        BetweenDateColCharConstCharConstVectorizedExpression condition =
            new BetweenDateColCharConstCharConstVectorizedExpression(
                3,
