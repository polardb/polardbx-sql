...
public class ParallelSortWindowTest extends PlanFragmentTestBase {
    protected String expectedFragment;

    public ParallelSortWindowTest(String caseName, int sqlIndex, String sql, String expectedPlan,
    ...
    public static List<Object[]> prepare() {
        ...
        return loadWithFragment(ParallelSortWindowTest.class);
    }
