...
import com.alibaba.polardbx.executor.vectorized.OrVectorizedExpression;
...
public class OrVectorizedExpressionTest {
    ...
    public void prev() {
        ...
        System.arraycopy(new double[] {0, 0, 0, 0, 0}, 0, doublesE, 0, SIZE);
     ...
     * c = {1, 1, 1, 1, 1}
     * d = {0, 1, 0, 1, 0} // c > d = {true, false, true, X, X}
     * e = {0, 0, 0, 0, 0}
     * f = {1, 2, 3, 4, 5} // e > f = {X, true, X, X, X}
     * <p>
     * (a > b) or (c > d) or (e > f) = {true, false, true, true, true}
     * sel[] = {0, 2, 3, 4}
     */
    @Test
    public void test() {
        ...
        VectorizedExpression orExpr = new OrVectorizedExpression(-1, new VectorizedExpression[] {aGtB, cGtD, eGtF});

        orExpr.eval(evaluationContext);

        check(new int[] {0, 2, 3, 4});
    }
