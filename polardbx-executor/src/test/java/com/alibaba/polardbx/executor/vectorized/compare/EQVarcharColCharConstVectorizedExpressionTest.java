...
public class EQVarcharColCharConstVectorizedExpressionTest {
    ...
    public EQVarcharColCharConstVectorizedExpressionTest(boolean compatible) {
    ...
    private void doTest(Chunk inputChunk, RandomAccessBlock expectBlock, String value, int[] sel) {
        ...
        Assert.assertTrue(condition instanceof EQVarcharColCharConstVectorizedExpression);
    ...
    private void doTestNull(Chunk inputChunk, RandomAccessBlock expectBlock, int[] sel) {
        EQVarcharColCharConstVectorizedExpression condition = new EQVarcharColCharConstVectorizedExpression(
            2,
