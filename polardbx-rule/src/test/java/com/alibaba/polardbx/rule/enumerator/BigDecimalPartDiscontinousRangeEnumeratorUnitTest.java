...
public class BigDecimalPartDiscontinousRangeEnumeratorUnitTest {
    ...
    public void test_没有自增的closeinterval() throws Exception {
        btc = TestUtils.gand(TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.GreaterThan), TestUtils
            .gcomp(BigDecimal.valueOf(5), TestUtils.LessThanOrEqual));
        try {
    ...
    public void test_带有自增的closeInterval() throws Exception {
        btc = TestUtils.gand(
            TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.GreaterThan), TestUtils.gcomp(5l, TestUtils.LessThanOrEqual));
    ...
    public void test_带有自增的closeInterval_1() throws Exception {
        btc = TestUtils.gand(
            TestUtils.gcomp(3l, TestUtils.GreaterThan), TestUtils.gcomp(BigDecimal.valueOf(5), TestUtils.LessThanOrEqual));
    ...
    public void test_开区间() throws Exception {
        btc = TestUtils.gand(TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.LessThanOrEqual), TestUtils
            .gcomp(BigDecimal.valueOf(5), TestUtils.GreaterThan));
    ...
    public void test_一个大于一个null在一个and中() throws Exception {
        btc = TestUtils.gand(TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.LessThanOrEqual), null);
        try {
    ...
    public void test_一个小于() throws Exception {
        btc = TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.LessThanOrEqual);
        Set<Object> s = e.getEnumeratedValue(btc, 5, 1, needMergeValueInCloseRange);
    ...
    public void test_一个小于一个等于() throws Exception {
        btc = TestUtils.gand(TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.LessThanOrEqual), TestUtils
            .gcomp(BigDecimal.valueOf(5), TestUtils.Equivalent));
        Set<Object> s = e.getEnumeratedValue(btc, 5, 1, needMergeValueInCloseRange);
        TestUtils.testSet(new Object[] {}, s);
    }
    ...
    public void test_一个等于一个大于() throws Exception {
        btc = TestUtils.gand(
            TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.Equivalent), TestUtils.gcomp(5l, TestUtils.GreaterThan));
        Set<Object> s = e.getEnumeratedValue(btc, 5, 1, needMergeValueInCloseRange);
        TestUtils.testSet(new Object[] {}, s);
    }
    ...
    public void test_两个等于() throws Exception {
        btc = TestUtils.gand(
            TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.LessThanOrEqual), TestUtils.gcomp(5l, TestUtils.Equivalent));
        Set<Object> s = e.getEnumeratedValue(btc, 5, 1, needMergeValueInCloseRange);
        TestUtils.testSet(new Object[] {}, s);
    }
    ...
    public void test_两个大于不是大于等于() throws Exception {
        btc = TestUtils.gand(
            TestUtils.gcomp(BigDecimal.valueOf(3), TestUtils.GreaterThan), TestUtils.gcomp(5l, TestUtils.GreaterThan));
        Set<Object> s = e.getEnumeratedValue(btc, 5, 1, needMergeValueInCloseRange);
