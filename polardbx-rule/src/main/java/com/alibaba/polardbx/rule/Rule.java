...
public interface Rule<T> {
     ...
     */
    public Map<T, ? extends Object> calculate(Map<String/* 列名 */, Comparative> sqlArgs, Object ctx,
                                              Object outerContext);
     ...
     * 它与outerContext的不同是，outerContext的作用域是表级别的，所以同一表的不同路由的参数是共用的
     */
    public T calculateVnodeNoTrace(String key, Object ctx, Object outerContext, Map<String, Object> calcParams);
