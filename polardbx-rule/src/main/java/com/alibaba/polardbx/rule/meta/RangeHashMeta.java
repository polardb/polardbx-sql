 ...
 * @since 5.0.0
 */
public class RangeHashMeta extends AbstractShardFunctionMeta {
    ...
    public String getRuleShardFuncionDetails() {
        ...
        return "range_hash(column1, column2, rangeCount)";
    }
    ...
    protected boolean ruleShardingEqualsInner(ShardFunctionMeta otherShardFunMeta, boolean isIgnoredShardKey) {
        ...
        if (!(otherShardFunMeta instanceof RangeHashMeta)) {
            return false;
        }

        RangeHashMeta otherRangeHashMeta = (RangeHashMeta) otherShardFunMeta;
            ...
            for (int i = 0; i < ruleSize; ++i) {
                ...
                for (Map.Entry<String, Rule.RuleColumn> ruleItem : rcMaps.entrySet()) {
                    if (ruleItem instanceof AdvancedParameter) {
                        ...
                        if (apRuleItem.atomicIncreateType == AdvancedParameter.AtomIncreaseType.STRING) {
                            this.isString = "true";
                        } else if (apRuleItem.atomicIncreateType == AdvancedParameter.AtomIncreaseType.NUMBER
                            || apRuleItem.atomicIncreateType == AdvancedParameter.AtomIncreaseType.NUMBER_ABS) {
                            this.isString = "false";
                        }
