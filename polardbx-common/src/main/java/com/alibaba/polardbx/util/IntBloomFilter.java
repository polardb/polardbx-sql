...
public final class IntBloomFilter {

    private final LockFreeBitArray bits;
    private final int numHashFunctions;

    private IntBloomFilter(LockFreeBitArray bits, int numHashFunctions) {
    ...
    public static IntBloomFilter create(long expectedInsertions) {
        return create(expectedInsertions, 0.03);
    }

    public static IntBloomFilter create(long expectedInsertions, double fpp) {
        ...
        try {
            return new IntBloomFilter(new LockFreeBitArray(numBits), numHashFunctions);
