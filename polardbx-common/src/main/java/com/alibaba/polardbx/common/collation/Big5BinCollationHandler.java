...
public class Big5BinCollationHandler extends AbstractCollationHandler {
    public Big5BinCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.BIG5_BIN;
    }
