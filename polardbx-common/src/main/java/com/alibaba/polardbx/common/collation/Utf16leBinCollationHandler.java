...
public class Utf16leBinCollationHandler extends AbstractCollationHandler {
    public Utf16leBinCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.UTF16LE_BIN;
    }
