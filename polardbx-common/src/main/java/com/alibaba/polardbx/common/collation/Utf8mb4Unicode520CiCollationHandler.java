...
public class Utf8mb4Unicode520CiCollationHandler extends Utf8mb4UnicodeCiCollationHandler {
    public Utf8mb4Unicode520CiCollationHandler(
    ...
    public CollationName getName() {
        return CollationName.UTF8MB4_UNICODE_520_CI;
    }
}
