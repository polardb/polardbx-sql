...
public class Utf16leGeneralCiCollationHandler extends AbstractCollationHandler {
    public Utf16leGeneralCiCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.UTF16LE_GENERAL_CI;
    }
