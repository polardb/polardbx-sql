...
public final class SearchArgumentImpl implements SearchArgument {
  ...
  static class BuilderImpl implements Builder {
    ...
    @Override
    public Builder greaterThan(String column, PredicateLeaf.Type type,
                               Object literal) {
      ExpressionTree parent = currentTree.getFirst();
      if (column == null || literal == null) {
        parent.getChildren().add(new ExpressionTree(TruthValue.YES_NO_NULL));
        ...
        PredicateLeaf leaf =
                new PredicateLeafImpl(PredicateLeaf.Operator.GREATER_THAN,
                        type, column, literal, null, conf);
        parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
      }
      return this;
    ...
    @Override
    public Builder greaterThanEquals(String column, PredicateLeaf.Type type,
                                     Object literal) {
      ExpressionTree parent = currentTree.getFirst();
      if (column == null || literal == null) {
        parent.getChildren().add(new ExpressionTree(TruthValue.YES_NO_NULL));
        ...
        PredicateLeaf leaf =
                new PredicateLeafImpl(PredicateLeaf.Operator.GREATER_THAN_EQUALS,
                        type, column, literal, null, conf);
        parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
      }
      return this;
