...
public class SelectExtractTraceId {
    ...
    public static boolean response(ServerConnection c, boolean hasMore, long traceId) {
        ...
        row.add(String.format("Timestamp: %s, Worker id: %d, Sequence: %s",
            new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(IdGenerator.extractTimestamp(traceId)),
            IdGenerator.extractWorkerId(traceId), IdGenerator.extractSequence(traceId)).getBytes());
