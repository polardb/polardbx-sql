 ...
 */
public class SelectCollationServer extends SingleColumnSimpleSelect {

    public SelectCollationServer(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectCollationServer(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode("utf8_general_ci", resultCharset);
        row.add(rawRowData);
    }
}
