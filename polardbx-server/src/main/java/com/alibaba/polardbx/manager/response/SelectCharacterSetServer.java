 ...
 */
public class SelectCharacterSetServer extends SingleColumnSimpleSelect {

    public SelectCharacterSetServer(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectCharacterSetServer(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode("utf8", resultCharset);
        row.add(rawRowData);
    }
}
