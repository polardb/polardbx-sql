 ...
 * select @@init_connect
 *
 * @author arnkore 2016-12-28 11:46
 */
public class SelectInitConnect extends SingleColumnSimpleSelect {

    public SelectInitConnect(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectInitConnect(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode("", resultCharset);
        row.add(rawRowData);
    }
}
