 ...
 * @since 5.4.2
 */
public final class SelectTransactionReadOnly extends SingleColumnSimpleSelect {

    public SelectTransactionReadOnly(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectTransactionReadOnly(String origColumnName) {
