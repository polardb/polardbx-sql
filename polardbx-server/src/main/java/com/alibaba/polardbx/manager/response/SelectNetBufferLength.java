 ...
 *
 * @author arnkore 2016-12-28 11:55
 */
public class SelectNetBufferLength extends SingleColumnSimpleSelect {

    public SelectNetBufferLength(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectNetBufferLength(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(16384);
        row.add(rawRowData);
    }
}
