 ...
 * select @@wait_timeout
 *
 * @author arnkore 2016-12-28 12:03
 */
public class SelectWaitTimeout extends SingleColumnSimpleSelect {

    public SelectWaitTimeout(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectWaitTimeout(String origColumnName) {
