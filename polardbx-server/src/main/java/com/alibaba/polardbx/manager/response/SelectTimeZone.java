 ...
 * select @@time_zone
 *
 * @author arnkore 2016-12-28 12:02
 */
public class SelectTimeZone extends SingleColumnSimpleSelect {

    public SelectTimeZone(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectTimeZone(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode("SYSTEM", resultCharset);
        row.add(rawRowData);
    }
}
