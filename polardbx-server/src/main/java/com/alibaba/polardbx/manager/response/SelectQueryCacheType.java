 ...
 */
public class SelectQueryCacheType extends SingleColumnSimpleSelect {

    public SelectQueryCacheType(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectQueryCacheType(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode("OFF", resultCharset);
        row.add(rawRowData);
    }
}
