 ...
 * @since 5.4.2
 */
public final class SelectTransactionIsolation extends SingleColumnSimpleSelect {

    public SelectTransactionIsolation(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectTransactionIsolation(String origColumnName) {
