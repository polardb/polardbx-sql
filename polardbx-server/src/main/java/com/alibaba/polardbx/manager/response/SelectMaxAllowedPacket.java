 ...
 *
 * @author arnkore 2016-12-27 14:30
 */
public class SelectMaxAllowedPacket extends SingleColumnSimpleSelect {

    public SelectMaxAllowedPacket(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectMaxAllowedPacket(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(4194304); // 4M -> 4 * 1024 * 1024
        row.add(rawRowData);
    }
}
