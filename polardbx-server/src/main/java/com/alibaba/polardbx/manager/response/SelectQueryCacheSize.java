 ...
 *
 * @author arnkore 2016-12-28 11:57
 */
public class SelectQueryCacheSize extends SingleColumnSimpleSelect {

    public SelectQueryCacheSize(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectQueryCacheSize(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(1048576);
        row.add(rawRowData);
    }
}
