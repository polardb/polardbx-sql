 ...
 *
 * @author arnkore 2016-12-28 11:56
 */
public class SelectNetWriteTimeout extends SingleColumnSimpleSelect {

    public SelectNetWriteTimeout(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectNetWriteTimeout(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(60);
        row.add(rawRowData);
    }
}
