 ...
 *
 * @author arnkore 2016-12-28 11:53
 */
public class SelectLowerCaseTableNames extends SingleColumnSimpleSelect {

    public SelectLowerCaseTableNames(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectLowerCaseTableNames(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(2);
        row.add(rawRowData);
    }
}
