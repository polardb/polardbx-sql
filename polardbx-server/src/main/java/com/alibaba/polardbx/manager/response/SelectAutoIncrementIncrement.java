 ...
 */
public final class SelectAutoIncrementIncrement extends SingleColumnSimpleSelect {

    public SelectAutoIncrementIncrement(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectAutoIncrementIncrement(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = LongUtil.toBytes(1);
        row.add(rawRowData);
    }
}
