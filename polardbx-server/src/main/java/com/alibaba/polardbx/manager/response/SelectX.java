...
/**
 * select 'x'
 * used in druid for query validation
 *
 * @author arnkore 2016-12-23 22:58
 */
public class SelectX extends SingleColumnSimpleSelect {

    public SelectX(String origColumnName, String aliasColumnName) {
        super(origColumnName, aliasColumnName);
    }

    public SelectX(String origColumnName) {
    ...
    protected void initRowData(String resultCharset) {
        byte[] rawRowData = StringUtil.encode(origColumnName, resultCharset);
        row.add(rawRowData);
    }
}
