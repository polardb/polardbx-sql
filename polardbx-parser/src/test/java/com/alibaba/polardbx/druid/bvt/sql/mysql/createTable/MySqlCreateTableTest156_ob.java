...
public class MySqlCreateTableTest156_ob
    ...
    public void test_0() throws Exception {
        ...
        assertEquals("CREATE TABLE `ar_ranking_001_t` (\n" +
                ...
                ") AUTO_INCREMENT = 1000001 DEFAULT CHARSET = utf8mb4 COMPRESSION = 'lz4_1.0' REPLICA_NUM = 3 BLOCK_SIZE = 16384 USE_BLOOM_FILTER = false TABLET_SIZE = 134217728 PCTFREE = 10 COMMENT 'ar平台数据排行榜';", stmt.toString());
    }
}