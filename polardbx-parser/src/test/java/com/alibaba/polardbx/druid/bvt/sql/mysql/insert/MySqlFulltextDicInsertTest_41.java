...
public class MySqlFulltextDicInsertTest_41 extends TestCase {

    public void test_insert_0() throws Exception {
        String sql = "insert into fulltext dictionary dic_name (c1, c2) values('v1','v2')";
        ...
        assertEquals("INSERT INTO FULLTEXT DICTIONARY dic_name (c1, c2)\n" + "VALUES ('v1', 'v2')", insertStmt.toString());
    }
