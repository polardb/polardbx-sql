...
public class Coronadb_hints_test_6_table_eq extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "/!TDDL:t1.partition_key=value and t2.partition_key=value1*/ select * from t";
        ...
        assertEquals("/*TDDL:t1.partition_key=value and t2.partition_key=value1*/\n" +
                "SELECT *\n" +
        ...
        assertEquals("PARTITIONS", hint.getFunctions().get(0).getName());
    }
