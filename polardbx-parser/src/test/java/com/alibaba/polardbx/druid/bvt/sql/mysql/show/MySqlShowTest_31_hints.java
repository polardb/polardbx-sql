...
public class MySqlShowTest_31_hints extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "/* +TDDL:scan()*/show create table t;";
        ...
        assertEquals("/*+TDDL:scan()*/\n" +
                "SHOW CREATE TABLE t;", stmt.toString());
        assertEquals("/*+TDDL:scan()*/\n" +
                "show create table t;", stmt.toLowerCaseString());
    }
