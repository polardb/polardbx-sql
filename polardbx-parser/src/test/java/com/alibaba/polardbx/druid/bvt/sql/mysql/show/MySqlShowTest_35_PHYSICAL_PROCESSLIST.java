...
public class MySqlShowTest_35_PHYSICAL_PROCESSLIST extends MysqlTest {
    ...
    public void test_3() throws Exception {
        String sql = "SHOW PHYSICAL_PROCESSLIST WHERE id != 1 ORDER BY id";
        ...
        assertEquals("SHOW PHYSICAL_PROCESSLIST WHERE id != 1 ORDER BY id", stmt.toString());
    }

    public void test_4() throws Exception {
        String sql = "SHOW PHYSICAL PROCESSLIST WHERE id != 1 ORDER BY id";
