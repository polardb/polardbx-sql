...
public class MySqlSetTest_7 extends TestCase {

    public void test_0() throws Exception {
        String sql = "set TRANSACTION POLICY 7";
...
//        System.out.println("orderBy : " + visitor.getOrderByColumns());
        ...
        assertEquals("SET TRANSACTION POLICY 7", stmt.toString());
        assertEquals("set transaction policy 7", stmt.toLowerCaseString());
    }
}
