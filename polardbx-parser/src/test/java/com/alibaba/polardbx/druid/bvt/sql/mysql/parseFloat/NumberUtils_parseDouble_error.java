...
public class NumberUtils_parseDouble_error extends TestCase {
    public void test_parse_float_0() throws Exception {
        Exception error = null;
        try {
            NumberUtils.parseDouble(null, 0, 1);
   ...
   public void test_parse_float_1() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(null, 0, 16);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
   ...
   public void test_parse_float_2() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(bytes, -1, 16);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
   ...
   public void test_parse_float_3() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(bytes, -1, 0);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
   ...
   public void test_parse_float_4() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(bytes, 0, bytes.length);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
   ...
   public void test_parse_float_14() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(bytes, 1, 2);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
   ...
   public void test_parse_float_15() throws Exception {
        ...
        try {
            ...
            NumberUtils.parseDouble(bytes, 0, 1);
        } catch (IllegalArgumentException ex) {
            error = ex;
        }
        assertNotNull(error);
