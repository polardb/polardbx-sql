...
public class MySqlExplainTest_5_presto extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "explain (type distributed, format graphviz) select * from t1";
...
//        assertTrue(visitor.getColumns().contains(new Column("t2", "id")));
        ...
        assertEquals("EXPLAIN (TYPE distributed, FORMAT graphviz) SELECT *\n" +
