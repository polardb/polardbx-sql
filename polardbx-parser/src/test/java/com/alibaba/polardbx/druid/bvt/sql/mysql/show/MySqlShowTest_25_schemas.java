...
public class MySqlShowTest_25_schemas extends MysqlTest {
    ...
    public void test_0() throws Exception {
        ...
        assertEquals("SHOW DATABASES", stmt.toString());
        assertEquals("show databases", stmt.toLowerCaseString());
    }
    ...
    public void test_1() throws Exception {
        ...
        assertEquals("SHOW DATABASES LIKE '%'", stmt.toString());
        assertEquals("show databases like '%'", stmt.toLowerCaseString());
    }
}
