...
public class MySqlInsertTest_17 extends MysqlTest {
    ...
    public void test_insert_rollback_on_fail() throws Exception {
        String sql = "INSERT INTO dashboard_crowd_analysis(cname,cvalue,orders,users,dt,tagid)\n"
...
//        System.out.println(SQLUtils.toMySqlString(insertStmt));
        ...
        String formatSql = "INSERT INTO dashboard_crowd_analysis (cname, cvalue, orders, users, dt\n" + "\t, tagid)\n"
