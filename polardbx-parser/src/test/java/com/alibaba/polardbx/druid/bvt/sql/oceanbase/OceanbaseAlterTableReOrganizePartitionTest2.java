 ...
 */
package com.alibaba.polardbx.druid.bvt.sql.oceanbase;
    ...
    public void test_0() throws Exception {
...

        {
            ...
            Assert.assertEquals("ALTER TABLE members"
                    + "\n\tREORGANIZE PARTITION s0, s1, p1, p2, p3 INTO (PARTITION m0 VALUES LESS THAN (1980), PARTITION m1 VALUES LESS THAN (2000));",
                                result);
        }
        {
