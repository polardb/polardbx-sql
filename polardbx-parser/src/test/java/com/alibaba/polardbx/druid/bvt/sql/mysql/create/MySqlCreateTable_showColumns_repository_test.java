...
public class MySqlCreateTable_showColumns_repository_test extends MysqlTest {
    ...
    public void test_0() throws Exception {
        ...
        assertEquals("CREATE TABLE `test1` (\n" +
                ...
                "\tKEY `k_c` (`c_tinyint`, `c_int`),\n" +
                "\tKEY `k_d` (`c_char`, `c_bigint`)\n" +
                ") ENGINE = InnoDB AUTO_INCREMENT = 1769503 DEFAULT CHARSET = utf8mb4 COMMENT '10000000'", repository.console("show create table test1"));
        ...
        assertEquals("CREATE TABLE test2 (\n" +
                ...
                "\t`c_longblob` longblob COMMENT 'longblob',\n" +
                "\tKEY `k_c` (`c_tinyint`, `c_int`)\n" +
                ") ENGINE = InnoDB AUTO_INCREMENT = 1769503 DEFAULT CHARSET = utf8mb4 COMMENT '10000000'", repository.console("show create table test2"));
