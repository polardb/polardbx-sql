...
public class Coronadb_hints_test_5_scan extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "/!TDDL:SCAN*/ select * from t";
        ...
        assertEquals("SCAN", hint.getFunctions().get(0).getName());
    }
    ...
    public void test_2() throws Exception {
        String sql = "/!TDDL:SCAN=t1*/ select * from t";
