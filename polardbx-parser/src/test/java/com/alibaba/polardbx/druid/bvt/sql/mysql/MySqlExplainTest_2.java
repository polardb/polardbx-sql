...
public class MySqlExplainTest_2 extends TestCase {

    public void test_0() throws Exception {
        String sql = "explain /*+ hints */ extended select * from foo";
...
//        assertTrue(visitor.getColumns().contains(new Column("t2", "id")));
        ...
        assertEquals("EXPLAIN /*+ hints */ EXTENDED SELECT *\n" +
                "FROM foo", stmt.toString());
    }
}
