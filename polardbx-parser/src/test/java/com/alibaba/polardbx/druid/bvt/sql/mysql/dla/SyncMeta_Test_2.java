 ...
 */
package com.alibaba.polardbx.druid.bvt.sql.mysql.dla;
...
public class SyncMeta_Test_2 extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "sync meta tables from `schema1` like '%xxx%';";
...
//        System.out.println("orderBy : " + visitor.getOrderByColumns());
        ...
        assertEquals("SYNC META TABLE FROM `schema1` LIKE '%xxx%';", stmt.toString());
