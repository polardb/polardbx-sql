...
public class Coronadb_hints_test_3_socket_timeout extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "/!TDDL:SOCKET_TIMEOUT=5*/ select * from t";
        ...
        assertEquals("/*TDDL:SOCKET_TIMEOUT=5*/\n" +
                "SELECT *\n" +
        ...
        assertEquals("SOCKET_TIMEOUT", hint.getFunctions().get(0).getName());
    }
