...
public class Coronadb_hints_test_4_forbid_execute_dml_all extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "/!TDDL:FORBID_EXECUTE_DML_ALL=false*/ select * from t";
        ...
        assertEquals("/*TDDL:FORBID_EXECUTE_DML_ALL=false*/\n" +
                "SELECT *\n" +
        ...
        assertEquals("FORBID_EXECUTE_DML_ALL", hint.getFunctions().get(0).getName());
    }
