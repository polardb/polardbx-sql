...
public class MySqlExplainTest_2_presto extends MysqlTest {

    public void test_0() throws Exception {
        String sql = "EXPLAIN (TYPE VALIDATE) SELECT regionkey, count(*) FROM nation GROUP BY 1;";
...
//        System.out.println("orderBy : " + visitor.getOrderByColumns());
        ...
        assertTrue(visitor.getTables().containsKey(new TableStat.Name("nation")));
//        assertTrue(visitor.getTables().containsKey(new TableStat.Name("t2")));
        
//        assertTrue(visitor.getColumns().contains(new Column("t2", "id")));

        assertEquals("EXPLAIN (TYPE VALIDATE) SELECT regionkey, count(*)\n" +
                "FROM nation\n" +
