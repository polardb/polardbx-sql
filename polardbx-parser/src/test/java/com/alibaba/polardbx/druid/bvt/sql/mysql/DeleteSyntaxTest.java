...
public class DeleteSyntaxTest extends TestCase {
    ...
    public void test_5() throws Exception {
        String sql =
            "delete from update_delete_base_with_index_one_multi_db_multi_tb join update_delete_base_with_index_one_multi_db_one_tb on update_delete_base_with_index_one_multi_db_multi_tb.pk = update_delete_base_with_index_one_multi_db_one_tb.pk;";
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("syntax error, bad table name for delete."));
        }
    }
    ...
    public void test_6() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("syntax error, expect using."));
        }
    }
    ...
    public void test_7() throws Exception {
        ...
        for (int i = 0; i < sqls.length; ++i) {
            SQLStatementParser parser = new MySqlStatementParser(sqls[i]);
            List<SQLStatement> stmtList = parser.parseStatementList();

            SQLStatement stmt = stmtList.get(0);

            Assert.assertEquals(expected[i], SQLUtils.toMySqlString(stmt));
        }
    }
