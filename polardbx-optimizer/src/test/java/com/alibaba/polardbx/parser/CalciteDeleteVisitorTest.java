 ...
 */
public class CalciteDeleteVisitorTest extends TestCase {
    public void test_0() throws Exception {
        String sql = "delete from tab1 t where name = 'calijun' and age > 10";
        ...
        SqlDelete sqlNode = (SqlDelete) visitor.getSqlNode();

        System.out.println(sqlNode);

        Assert.assertEquals(sqlNode.toString(), "DELETE `t` FROM `tab1` AS `t`\n"
            + "WHERE ((`name` = 'calijun') AND (`age` > 10))");
