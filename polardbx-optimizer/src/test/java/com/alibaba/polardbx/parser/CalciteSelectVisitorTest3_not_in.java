...
public class CalciteSelectVisitorTest3_not_in extends TestCase {
    public void test_for_calcite() throws Exception {
        String sql = "select * from elastic where foo not in (1, 2, 3)";
    ...
    public void test_for_calcite_1() throws Exception {
        String sql = "select * from elastic where not foo in (1, 2, 3)";
