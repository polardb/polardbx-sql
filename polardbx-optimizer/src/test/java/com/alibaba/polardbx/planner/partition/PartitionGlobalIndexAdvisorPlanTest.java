 ...
 * @author dylan
 */
public class PartitionGlobalIndexAdvisorPlanTest extends AdvisorTestCommon {

    public PartitionGlobalIndexAdvisorPlanTest(String caseName, int sqlIndex, String sql, String expectedPlan, String lineNum) {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(PartitionGlobalIndexAdvisorPlanTest.class);
    }
