 ...
 * @author dylan
 */
public class PartitionLocalIndexAdvisorPlanTest extends AdvisorTestCommon {

    public PartitionLocalIndexAdvisorPlanTest(String caseName, int sqlIndex, String sql, String expectedPlan, String lineNum) {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(PartitionLocalIndexAdvisorPlanTest.class);
    }
