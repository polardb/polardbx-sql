 ...
 * @author chenghui.lch
 */
public class PartitionRoutingPlanTest extends PlanTestCommon {

    public PartitionRoutingPlanTest(String caseName, int sqlIndex, String sql, String expectedPlan, String lineNum) {
    ...
    public static List<Object[]> prepare() {
        return loadSqls(PartitionRoutingPlanTest.class);
    }
