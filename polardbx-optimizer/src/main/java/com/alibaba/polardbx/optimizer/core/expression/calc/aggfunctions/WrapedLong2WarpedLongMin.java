...
public class WrapedLong2WarpedLongMin extends WrapedLong2WarpedLongMax {
    public WrapedLong2WarpedLongMin(int index, DataType inputType, DataType outputType, int filterArg) {
