...
public class InformationSchemaProcesslist extends VirtualView {

    public InformationSchemaProcesslist(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.PROCESSLIST);
    }

    public InformationSchemaProcesslist(RelInput relInput) {
        super(relInput);
    }
    ...
    protected RelDataType deriveRowType() {
        ...
        columns.add(new RelDataTypeFieldImpl("SQL_TEMPLATE_ID", 8, typeFactory.createSqlType(SqlTypeName.VARCHAR)));
