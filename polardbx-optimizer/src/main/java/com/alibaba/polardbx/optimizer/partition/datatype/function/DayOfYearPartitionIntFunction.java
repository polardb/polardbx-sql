 ...
 * Created by zhuqiwei.
 */
public class DayOfYearPartitionIntFunction extends PartitionIntFunction {

    public DayOfYearPartitionIntFunction(List<DataType> operandTypes, DataType resultType) {
    ...
    public String[] getFunctionNames() {
        return new String[] {"DayOfYearPartitionInt"};
    }

    @Override
    public SqlOperator getSqlOperator() {
        return TddlOperatorTable.DAYOFYEAR;
    }
