...
public class Utf8UnicodeCiCollationHandler extends Utf8mb4UnicodeCiCollationHandler {
    public Utf8UnicodeCiCollationHandler(
    ...
    public CollationName getName() {
        return CollationName.UTF8_UNICODE_CI;
    }
}
