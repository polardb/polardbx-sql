 ...
 * Created by zhuqiwei.
 */
public class DayOfWeekPartitionIntFunction extends PartitionIntFunction {

    public DayOfWeekPartitionIntFunction(List<DataType> operandTypes, DataType resultType) {
    ...
    public long evalInt(PartitionField partitionField, SessionProperties sessionProperties) {
        ...
        if (t == null) {
            ...
            return PartitionFunctionTimeCaculator.calDayOfWeek(
                t.getYear(),
                t.getMonth(),
                t.getDay()
            );
    ...
    public String[] getFunctionNames() {
        return new String[] {"DayOfWeekPartitionInt"};
    }

    @Override
    public SqlOperator getSqlOperator() {
        return TddlOperatorTable.DAYOFWEEK;
    }
}
