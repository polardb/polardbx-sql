 ...
 * @author dylan
 */
public class InformationSchemaTables extends VirtualView {

    /**
     * support getting statistics from information_schema.TABLES for gsi
     */
    private boolean includeGsi = false;

    public void setIncludeGsi(boolean includeGsi) {
        this.includeGsi = includeGsi;
    }

    public boolean includeGsi() {
        return this.includeGsi;
    }

    public InformationSchemaTables(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.TABLES);
    }

    public InformationSchemaTables(RelInput relInput) {
        super(relInput);
    }
