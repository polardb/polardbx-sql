 ...
 * @author chenmo.cm
 */
public class ShardingModifyGsiWriter extends AbstractSingleWriter implements DistinctWriter, GsiWriter {

    protected final ShardingModifyWriter deleteWriter;
    protected final ShardingModifyWriter updateWriter;

    protected final TableMeta gsiMeta;

    public ShardingModifyGsiWriter(RelOptTable targetTable, Operation op, ShardingModifyWriter updateWriter,
                                   ShardingModifyWriter deleteWriter, TableMeta gsiMeta) {
    ...
    public ShardingModifyWriter getDeleteWriter() {
        return deleteWriter;
    }

    public ShardingModifyWriter getUpdateWriter() {
        return updateWriter;
    }
    ...
    public Mapping getGroupingMapping() {
        return deleteWriter.groupingMapping;
    }
