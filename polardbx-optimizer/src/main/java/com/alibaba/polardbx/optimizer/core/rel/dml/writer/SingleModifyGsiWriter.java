 ...
 * @author chenmo.cm
 */
public class SingleModifyGsiWriter extends AbstractSingleWriter implements DistinctWriter, GsiWriter {

    protected final SingleModifyWriter deleteWriter;
    protected final SingleModifyWriter updateWriter;

    protected final TableMeta gsiMeta;

    public SingleModifyGsiWriter(RelOptTable targetTable, Operation op, SingleModifyWriter updateWriter,
    ...
    public SingleModifyWriter getDeleteWriter() {
        return deleteWriter;
    }

    public SingleModifyWriter getUpdateWriter() {
        return updateWriter;
    }
