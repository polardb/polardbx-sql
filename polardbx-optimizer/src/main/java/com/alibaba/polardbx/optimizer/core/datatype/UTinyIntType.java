...
/**
 * unsigned tinyint类型, 可基于ShortType做计算
 *
 * @author agapple 2014年11月21日 上午11:19:51
 * @since 5.1.14
 */
public class UTinyIntType extends ShortType {

    private static final short MIN_VALUE = 0;
    private static final short MAX_VALUE = (short) Byte.MAX_VALUE - (short) Byte.MIN_VALUE;
    ...
    protected Short convertToShort(Object value) {
        short val = convertFrom(value);
        val = val >= 0 ? val : (short) (val + MAX_VALUE + 1);
        return val;
    }
}
