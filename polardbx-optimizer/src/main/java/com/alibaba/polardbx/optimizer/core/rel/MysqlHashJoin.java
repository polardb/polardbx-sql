 ...
 * @author dylan
 */
public class MysqlHashJoin extends Join implements MysqlRel {

    private final boolean semiJoinDone;
    private final ImmutableList<RelDataTypeField> systemFieldList;

    public MysqlHashJoin(
    ...
    public MysqlHashJoin(RelInput relInput) {
    ...
    public static MysqlHashJoin create(RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition,
                                       Set<CorrelationId> variablesSet,
                                       JoinRelType joinType, boolean semiJoinDone,
                                       ImmutableList<RelDataTypeField> systemFieldList, SqlNodeList hints) {
        final RelOptCluster cluster = left.getCluster();
        return new MysqlHashJoin(cluster, traitSet, left, right, condition,
    ...
    @Override
    public MysqlHashJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
                              RelNode left, RelNode right, JoinRelType joinType, boolean semiJoinDone) {
        MysqlHashJoin mysqlHashJoin = new MysqlHashJoin(getCluster(),
            traitSet, left, right, conditionExpr,
            variablesSet, joinType, semiJoinDone, systemFieldList, hints);
        return mysqlHashJoin;
    }
