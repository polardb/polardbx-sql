 ...
 * @author chenghui.lch
 */
public class ConstExprEvalParams {

    /**
     * Input params
     */
    protected ExecutionContext executionContext;
    protected PartPruneStepPruningContext pruningCtx;
    protected IExpression calcExpr = null;
    protected Integer constExprId = null;
    protected boolean needCacheEvalResult = false;
