 ...
 * Created by zhuqiwei.
 */
public class DayOfMonthPartitionIntFunction extends PartitionIntFunction {

    public DayOfMonthPartitionIntFunction(List<DataType> operandTypes, DataType resultType) {
    ...
    public String[] getFunctionNames() {
        return new String[] {"DayOfMonthPartitionInt"};
    }

    @Override
    public SqlOperator getSqlOperator() {
        return TddlOperatorTable.DAYOFMONTH;
    }
}
