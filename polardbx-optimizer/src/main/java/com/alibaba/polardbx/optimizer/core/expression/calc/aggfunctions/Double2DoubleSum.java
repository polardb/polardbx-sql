...
public final class Double2DoubleSum extends LittleNum2DoubleSum {
    public Double2DoubleSum(int targetIndexes, boolean distinct, DataType inputType, DataType outputType,
                            int filterArg) {
