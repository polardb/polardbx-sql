 ...
 */
public class RenameGroupSequence extends RenameSequence {

    public RenameGroupSequence(Pair<String, String> namePair) {
        super(namePair);
    }

    @Override
    protected RenameSequence getRenameSequence(Pair<String, String> namePair) {
        return new RenameGroupSequence(namePair);
    }

    @Override
    public String getSql() {
        StringBuilder sb = new StringBuilder();
        sb.append("UPDATE ").append(DEFAULT_GROUP_TABLE_NAME);
