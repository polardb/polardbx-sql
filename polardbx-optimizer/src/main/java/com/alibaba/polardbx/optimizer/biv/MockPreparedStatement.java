...
public class MockPreparedStatement implements PreparedStatement {
    ...
    public MockPreparedStatement(MockConnection mockConnection, String sql) {
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        MockUtils.replaceParams(sql, params, sb);
        sql = MockUtils.stripSql(sb.toString(), mockConnection.getLogicalSchema(), params);
        if (MockUtils.isSqlNeedTransparent(sql, mockConnection.getLogicalSchema(), params)) {
        ...
        return new MockResultSet(this, MockUtils.buildMeta(sql, mockConnection.getLogicalSchema(), params),
    ...
    public ResultSet getResultSet() throws SQLException {
        ...
        MockUtils.replaceParams(sql, params, sb);
        sql = MockUtils.stripSql(sb.toString(), mockConnection.getLogicalSchema(), params);
        String traceId = MockUtils.stripStraceId(sb.toString());
        if (MockUtils.isSqlNeedTransparent(sql, mockConnection.getLogicalSchema(), params)) {
            mockCacheData = MockDataManager.buildCacheData(sql, this.mockConnection);
            return new MockResultSet(mockCacheData);
        }
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        return MockUtils.buildGenerateKeyRs(1);
    }
