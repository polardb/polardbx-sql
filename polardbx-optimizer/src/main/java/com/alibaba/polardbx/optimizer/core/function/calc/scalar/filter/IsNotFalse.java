 ...
 * @since 5.0.0
 */
public class IsNotFalse extends AbstractCollationScalarFunction {
    public IsNotFalse(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        if (FunctionUtils.isNull(arg)) {
            // Null does not equal or unequal to anything
            return 1L;
        }

        Long bool = DataTypes.LongType.convertFrom(arg);
        return (bool != 0) != false ? 1L : 0L;
    }
