...
public class Utf32GeneralCiCollationHandler extends AbstractCollationHandler {
    public Utf32GeneralCiCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.UTF32_GENERAL_CI;
    }
