...
public class Int2IntMin extends Int2IntMax {
    public Int2IntMin(int index, DataType inputType, DataType outputType, int filterArg) {
    ...
    public void accumulate(int groupId, Chunk chunk, int position) {
        ...
        if (groupState.isNull(groupId)) {
            ...
            int afterValue = Math.min(value, beforeValue);
