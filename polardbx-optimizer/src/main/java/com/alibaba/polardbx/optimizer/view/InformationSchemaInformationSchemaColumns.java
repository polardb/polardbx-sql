 ...
 * @author dylan
 */
public class InformationSchemaInformationSchemaColumns extends VirtualView {

    public InformationSchemaInformationSchemaColumns(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.INFORMATION_SCHEMA_COLUMNS);
    }

    public InformationSchemaInformationSchemaColumns(RelInput relInput) {
        super(relInput);
    }
