...
public class Short2DecimalSum extends LittleNum2DecimalSum {
    public Short2DecimalSum(int targetIndexes, boolean distinct, DataType inputType, DataType outputType,
                            int filterArg) {
