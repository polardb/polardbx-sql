 ...
 * @author dylan
 */
public abstract class AbstractInnerJoinLeftAssociateRule extends RelOptRule {

    public AbstractInnerJoinLeftAssociateRule(RelOptRuleOperand operand, RelBuilderFactory relBuilderFactory,
                                              String description) {
    ...
    protected void onMatchProjectInstance(RelOptRuleCall call) {
        ...
        final RelNode relA = call.rel(1);
        final LogicalProject logicalProject = call.rel(2);
        final LogicalJoin bottomJoin = call.rel(3);
