...
/**
 * @author wuheng.zxy 2016-5-21 上午11:55:16
 */
public class JsonType extends JsonExtraFunction {
    public JsonType(List<DataType> operandTypes, DataType resultType) {
        super(operandTypes, resultType);
    }

    @Override
    public String[] getFunctionNames() {
        return new String[] {"JSON_TYPE"};
    }
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        if (args[0] == null) {
            return JsonUtil.JsonType.J_NULL.getValue();
        }
        ...
        return JsonUtil.getType(target);
    }
}
