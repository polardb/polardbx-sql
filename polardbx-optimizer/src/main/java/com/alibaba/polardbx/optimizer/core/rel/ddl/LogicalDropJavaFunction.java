...
public class LogicalDropJavaFunction extends BaseDdlOperation {
    ...
    private SqlDropJavaFunction sqlDropFunction;

    public LogicalDropJavaFunction(DropJavaFunction dropJavaFunction) {
        super(dropJavaFunction);
        sqlDropFunction = (SqlDropJavaFunction) dropJavaFunction.sqlNode;
    }
    ...
    public SqlDropJavaFunction getSqlDropFunction() {
