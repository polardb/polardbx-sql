...
public class Float2DoubleAvg extends SpecificType2DoubleAvgV2 {
    public Float2DoubleAvg(int index, boolean isDistict, DataType inputType, DataType outputType, int filterArg) {
