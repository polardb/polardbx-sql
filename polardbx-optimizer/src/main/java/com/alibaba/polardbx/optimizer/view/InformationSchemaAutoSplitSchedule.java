...
public class InformationSchemaAutoSplitSchedule extends VirtualView {

    public InformationSchemaAutoSplitSchedule(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.AUTO_SPLIT_SCHEDULE);
    }

    public InformationSchemaAutoSplitSchedule(RelInput relInput) {
        super(relInput);
    }
    ...
    protected RelDataType deriveRowType() {
        ...
        columns.add(
            new RelDataTypeFieldImpl("TABLE_GROUP_NAME", index++, typeFactory.createSqlType(SqlTypeName.VARCHAR)));
        ...
        columns.add(new RelDataTypeFieldImpl("CONTENT", index++, typeFactory.createSqlType(SqlTypeName.VARCHAR)));
        columns.add(
