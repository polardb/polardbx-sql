...
/**
 * @author wuheng.zxy 2016-5-21 上午11:31:13
 */
public class JsonDepth extends JsonExtraFunction {
    public JsonDepth(List<DataType> operandTypes, DataType resultType) {
        super(operandTypes, resultType);
    }

    @Override
    public String[] getFunctionNames() {
        return new String[] {"JSON_DEPTH"};
    }
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        return JsonDocProcessor.getDepth(target);
    }
}
