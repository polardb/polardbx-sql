...
public class Utf8mb4BinCollationHandler extends AbstractCollationHandler {

    public Utf8mb4BinCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.UTF8MB4_BIN;
    }
