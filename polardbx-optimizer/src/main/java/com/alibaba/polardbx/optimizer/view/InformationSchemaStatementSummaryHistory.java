...
/**
 * @author busu
 * date: 2021/11/15 8:24 下午
 */
public class InformationSchemaStatementSummaryHistory extends VirtualView {

    public InformationSchemaStatementSummaryHistory(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.STATEMENTS_SUMMARY_HISTORY);
    }
    ...
    protected RelDataType deriveRowType() {
        ...
        columns
            .add(new RelDataTypeFieldImpl("SUM_BUILD_PLAN_CPU_TIME_MS", 0,
                typeFactory.createSqlType(SqlTypeName.DOUBLE)));
        columns
            .add(new RelDataTypeFieldImpl("AVG_BUILD_PLAN_CPU_TIME_MS", 0,
                typeFactory.createSqlType(SqlTypeName.DOUBLE)));
        columns
            .add(new RelDataTypeFieldImpl("MAX_BUILD_PLAN_CPU_TIME_MS", 0,
                typeFactory.createSqlType(SqlTypeName.DOUBLE)));
