 ...
 * @since 5.0.0
 */
public class Add extends AbstractScalarFunction {
    public Add(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        if (resultType.getCalculator() != cal) {
            return resultType.convertFrom(cal.add(args[0], args[1]));
        } else {
