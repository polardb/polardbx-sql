...
public class IsFreeLock extends AbstractScalarFunction {
    public IsFreeLock(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        Integer count = 0;
        try {
            count = lockHandle.isFreeLock(lockName);
        } catch (SQLException e) {
            GeneralUtil.nestedException("fail to call is_free_lock", e);
        }
        return count;
    }
    ...
    public String[] getFunctionNames() {
        return new String[] {"IS_FREE_LOCK"};
    }
}
