 ...
 * @since 5.0.7
 */
public class Floor extends AbstractScalarFunction {
    public Floor(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        return resultType.convertFrom(Math.floor(d));
    }
