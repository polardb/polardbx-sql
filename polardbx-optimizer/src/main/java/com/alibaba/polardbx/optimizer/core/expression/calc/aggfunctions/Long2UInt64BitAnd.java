...
public class Long2UInt64BitAnd extends SpecificType2UInt64BitAnd {
    public Long2UInt64BitAnd(int index, DataType inputTypes, int filterArg) {
        super(index, inputTypes, filterArg);
    }

    @Override
    protected UInt64 getUInt64(Block block, int position) {
        return ULongType.instance.convertFrom(block.getLong(position));
    }
}
