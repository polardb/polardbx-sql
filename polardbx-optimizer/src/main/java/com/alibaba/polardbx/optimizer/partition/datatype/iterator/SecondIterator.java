...
public class SecondIterator extends AbstractDateIterator {
    public SecondIterator(DataType fieldType) {
        super(fieldType);
    }
    ...
    public boolean hasNext() {
        ...
        MysqlDateTime newDatetime = MySQLTimeCalculator.addInterval(
            currentDatetime,
            MySQLIntervalType.INTERVAL_SECOND,
