...
/**
 * @author busu
 * date: 2020/10/27 4:31 下午
 */
public class LogicalCcl extends LogicalDal {
    private LogicalCcl(Dal dal) {
        super(dal, "", "", null);
    }

    public static LogicalCcl create(Dal dal) {
        return new LogicalCcl(dal);
    }
