...
public class MysqlSemiIndexNLJoin extends SemiJoin implements MysqlRel {
    ...
    public MysqlSemiIndexNLJoin(RelInput relInput) {
    ...
    public static MysqlSemiIndexNLJoin create(RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition,
                                              Set<CorrelationId> variablesSet,
                                              JoinRelType joinType, boolean semiJoinDone,
                                              ImmutableList<RelDataTypeField> systemFieldList, SqlNodeList hints) {
        final RelOptCluster cluster = left.getCluster();
        final JoinInfo joinInfo = JoinInfo.of(left, right, condition);
        return new MysqlSemiIndexNLJoin(cluster, traitSet, left, right, condition, joinInfo.leftKeys,
    ...
    @Override
    public MysqlSemiIndexNLJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
                                     RelNode left, RelNode right, JoinRelType joinType, boolean semiJoinDone) {
        MysqlSemiIndexNLJoin mysqlJoin = new MysqlSemiIndexNLJoin(getCluster(),
    ...
    public RelWriter explainTermsForDisplay(RelWriter pw) {
        String name = "MysqlSemiIndexNLJoin";
