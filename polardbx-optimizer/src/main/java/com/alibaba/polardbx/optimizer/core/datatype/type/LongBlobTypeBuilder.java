...
public class LongBlobTypeBuilder extends AbstractBasicSqlTypeBuilder {
    public static LongBlobTypeBuilder INSTANCE = new LongBlobTypeBuilder();

    private LongBlobTypeBuilder() {
    }
