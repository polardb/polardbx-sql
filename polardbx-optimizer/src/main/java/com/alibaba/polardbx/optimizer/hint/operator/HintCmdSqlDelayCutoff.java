 ...
 * @author chenmo.cm
 */
public class HintCmdSqlDelayCutoff extends BaseHintOperator implements HintCmdOperator {

    private long delayCutoff = Long.MIN_VALUE;

    public HintCmdSqlDelayCutoff(SqlBasicCall hint, ExecutionContext ec) {
        super(hint, ec);
    ...
    protected List<HintArgKey> getArgKeys() {
        return HintArgKey.SQL_DELAY_CUTOFF_HINT;
    }
