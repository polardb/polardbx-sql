...
public abstract class SpecificType2UInt64BitOr extends AbstractAggregator {
    private NullableUInt64GroupState groupState;

    public SpecificType2UInt64BitOr(int index, DataType inputTypes, int filterArg) {
    ...
    public void accumulate(int groupId, Chunk chunk, int position) {
        ...
        groupState.set(groupId, beforeValue.bitOr(value));
    }
