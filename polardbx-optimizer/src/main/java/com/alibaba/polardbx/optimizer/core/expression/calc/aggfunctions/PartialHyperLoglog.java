...
import static org.apache.calcite.sql.SqlKind.PARTIAL_HYPER_LOGLOG;

/**
 * hyperloglog is used by analyze table
 */
public class PartialHyperLoglog extends Aggregator {

    public PartialHyperLoglog() {
    }

    public PartialHyperLoglog(int[] index, int filterArg) {
    ...
    public Aggregator getNew() {
        return new PartialHyperLoglog(aggTargetIndexes, filterArg);
    }

    @Override
    public SqlKind getSqlKind() {
        return PARTIAL_HYPER_LOGLOG;
    }
    ...
    public String[] getFunctionNames() {
        return new String[] {"PART_HYPER_LOGLOG"};
    }
