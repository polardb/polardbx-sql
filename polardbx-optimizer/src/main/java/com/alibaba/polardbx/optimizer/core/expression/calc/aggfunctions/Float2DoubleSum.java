...
public final class Float2DoubleSum extends LittleNum2DoubleSum {
    public Float2DoubleSum(int targetIndexes, boolean distinct, DataType inputType, DataType outputType,
                           int filterArg) {
