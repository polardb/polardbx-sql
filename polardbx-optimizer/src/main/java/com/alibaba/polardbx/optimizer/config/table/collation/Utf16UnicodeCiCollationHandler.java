...
import static com.alibaba.polardbx.optimizer.config.table.collation.Utf16GeneralCiCollationHandler.codepointOfUTF16;

public class Utf16UnicodeCiCollationHandler extends AbstractUCACollationHandler {

    public Utf16UnicodeCiCollationHandler(CharsetHandler charsetHandler) {
        super(charsetHandler);
    }

    @Override
    public CollationName getName() {
        return CollationName.UTF16_UNICODE_CI;
    }
    ...
    public int getCodePoint(SliceInput sliceInput) {
        return codepointOfUTF16(sliceInput);
    }
