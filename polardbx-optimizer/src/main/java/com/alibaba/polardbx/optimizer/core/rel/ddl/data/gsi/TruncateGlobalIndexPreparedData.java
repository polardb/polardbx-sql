...
public class TruncateGlobalIndexPreparedData extends DdlPreparedData {

    private TruncateTablePreparedData indexTablePreparedData;

    private String primaryTableName;

    public TruncateTablePreparedData getIndexTablePreparedData() {
        return indexTablePreparedData;
    }

    public void setIndexTablePreparedData(TruncateTablePreparedData indexTablePreparedData) {
