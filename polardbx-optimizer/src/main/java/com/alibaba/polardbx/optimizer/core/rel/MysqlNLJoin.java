 ...
 * @author dylan
 */
public class MysqlNLJoin extends Join implements MysqlRel {
    ...
    public MysqlNLJoin(RelInput relInput) {
    ...
    public static MysqlNLJoin create(RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition,
                                     Set<CorrelationId> variablesSet,
                                     JoinRelType joinType, boolean semiJoinDone,
                                     ImmutableList<RelDataTypeField> systemFieldList, SqlNodeList hints) {
        final RelOptCluster cluster = left.getCluster();
        return new MysqlNLJoin(cluster, traitSet, left, right, condition,
    ...
    @Override
    public MysqlNLJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
                            RelNode left, RelNode right, JoinRelType joinType, boolean semiJoinDone) {
        MysqlNLJoin mysqlJoin = new MysqlNLJoin(getCluster(),
