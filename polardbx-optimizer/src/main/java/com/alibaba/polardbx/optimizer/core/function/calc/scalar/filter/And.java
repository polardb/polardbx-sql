 ...
 * @since 5.0.0
 */
public class And extends AbstractCollationScalarFunction {
    public And(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        for (Object arg : args) {
            if (arg != null && !(BooleanType.isTrue(DataTypes.BooleanType.convertFrom(arg)))) {
                return 0L;
            }
            if (arg == null) {
                hasNull = true;
