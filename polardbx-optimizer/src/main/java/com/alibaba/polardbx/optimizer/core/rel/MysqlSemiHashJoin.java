 ...
 * @author dylan
 */
public class MysqlSemiHashJoin extends SemiJoin implements MysqlRel {

    private final boolean semiJoinDone;
    private final ImmutableList<RelDataTypeField> systemFieldList;

    public MysqlSemiHashJoin(
    ...
    public MysqlSemiHashJoin(RelInput relInput) {
    ...
    public static MysqlSemiHashJoin create(RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition,
                                           Set<CorrelationId> variablesSet,
                                           JoinRelType joinType, boolean semiJoinDone,
                                           ImmutableList<RelDataTypeField> systemFieldList, SqlNodeList hints) {
        final RelOptCluster cluster = left.getCluster();
        final JoinInfo joinInfo = JoinInfo.of(left, right, condition);
        return new MysqlSemiHashJoin(cluster, traitSet, left, right, condition, joinInfo.leftKeys,
    ...
    @Override
    public MysqlSemiHashJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
                                  RelNode left, RelNode right, JoinRelType joinType, boolean semiJoinDone) {
        MysqlSemiHashJoin mysqlJoin = new MysqlSemiHashJoin(getCluster(),
