...
/**
 * Created by chuanqin on 18/3/29.
 */
public class SequenceNextVal extends AbstractScalarFunction {

    public SequenceNextVal(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        return SequenceManagerProxy.getInstance().nextValue(schemnName, seqName);
    }
