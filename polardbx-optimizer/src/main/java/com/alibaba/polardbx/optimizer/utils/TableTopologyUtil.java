...
public class TableTopologyUtil {
    ...
    public static boolean isBroadcast(TableMeta tableMeta) {
        return OptimizerContext.getContext(tableMeta.getSchemaName()).getRuleManager().isBroadCast(tableMeta.getTableName());
    }
    ...
    public static boolean isShard(TableMeta tableMeta) {
        return OptimizerContext.getContext(tableMeta.getSchemaName()).getRuleManager().isShard(tableMeta.getTableName());
    }
