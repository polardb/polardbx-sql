 ...
 */
public class WeekOfYearIterator extends AbstractDateIterator {
    private boolean hasExceedBound;

    public WeekOfYearIterator(DataType fieldType) {
        super(fieldType);
        this.hasExceedBound = false;
    }
    ...
    public boolean hasNext() {
        ...
        long currPackedLong = TimeStorage.writeTimestamp(newDatetime);
        if (currPackedLong >= endPackedLong) {
            this.hasExceedBound = true;
        }
