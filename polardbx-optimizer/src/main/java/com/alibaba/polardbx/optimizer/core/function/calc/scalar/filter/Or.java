 ...
 * @since 5.0.0
 */
public class Or extends AbstractCollationScalarFunction {
    public Or(List<DataType> operandTypes, DataType resultType) {
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        for (Object arg : args) {
            if (BooleanType.isTrue(DataTypes.BooleanType.convertFrom(arg))) {
                return 1L;
            }
            if (arg == null) {
                hasNull = true;
