...
public class JsonPretty extends JsonExtraFunction {
    public JsonPretty(List<DataType> operandTypes, DataType resultType) {
        super(operandTypes, resultType);
    }

    @Override
    public String[] getFunctionNames() {
        return new String[] {"JSON_PRETTY"};
    }
    ...
    public Object compute(Object[] args, ExecutionContext ec) {
        ...
        return JSON.toJSONString(target, SerializerFeature.PrettyFormat);
    }
}
