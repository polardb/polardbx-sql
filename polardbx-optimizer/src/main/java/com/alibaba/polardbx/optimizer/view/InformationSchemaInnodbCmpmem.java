...
public class InformationSchemaInnodbCmpmem extends VirtualView {

    public InformationSchemaInnodbCmpmem(RelOptCluster cluster, RelTraitSet traitSet) {
        super(cluster, traitSet, VirtualViewType.INNODB_CMPMEM);
    }

    public InformationSchemaInnodbCmpmem(RelInput relInput) {
        super(relInput);
    }
