...
public class TimestampBlockEncoding implements BlockEncoding {
    ...
    public void writeBlock(SliceOutput sliceOutput, Block block) {
        ...
        // write zone id
        TimeZone zone = timestampBlock.getTimezone();
        ...
        long[] packed = timestampBlock.getPacked();
    ...
    public Block readBlock(SliceInput sliceInput) {
        ...
        DataType dataType = new DateTimeType(scale);
        ...
        return new TimestampBlock(0, positionCount, valueIsNull, packed, dataType, zone);
    }
}
