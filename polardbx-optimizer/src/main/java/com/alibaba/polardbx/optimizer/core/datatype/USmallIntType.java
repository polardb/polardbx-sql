...
/**
 * unsigned smallint类型, 可基于IntegerType做计算
 *
 * @author agapple 2014年11月21日 上午11:19:51
 * @since 5.1.14
 */
public class USmallIntType extends IntegerType {

    private static final int MIN_VALUE = 0;
    private static final int MAX_VALUE = (int) Short.MAX_VALUE - (int) Short.MIN_VALUE;
