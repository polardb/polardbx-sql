 ...
 */
public class BitXor extends AbstractAggregator {
    private NullableObjectGroupState groupState;

    public BitXor(int index, DataType inputTypes, DataType outType, int filterArg) {
    ...
    public void accumulate(int groupId, Chunk chunk, int position) {
        ...
        groupState.set(groupId, returnType.getCalculator().bitXor(value, beforeValue));
    }
