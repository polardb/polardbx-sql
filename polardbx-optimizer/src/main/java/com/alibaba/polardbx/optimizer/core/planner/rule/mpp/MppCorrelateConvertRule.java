 ...
 * @author fangwu
 */
public class MppCorrelateConvertRule extends ConverterRule {
    public static final MppCorrelateConvertRule INSTANCE = new MppCorrelateConvertRule();

    MppCorrelateConvertRule() {
        super(LogicalCorrelate.class, DrdsConvention.INSTANCE, MppConvention.INSTANCE, "MppCorrelateConvertRule");
    }
