...
public class DrdsSortCorrelateTransposeRule extends RelOptRule {
    public static final DrdsSortCorrelateTransposeRule INSTANCE =
        new DrdsSortCorrelateTransposeRule(Sort.class, LogicalProject.class,
     ...
     */
    public DrdsSortCorrelateTransposeRule(
     ...
     */
    protected DrdsSortCorrelateTransposeRule(RelOptRuleOperand operand,
                                             RelBuilderFactory relBuilderFactory, String description) {
    ...
    public boolean matches(RelOptRuleCall call) {
        ...
        return sort instanceof LogicalSort || sort instanceof MemSort || sort instanceof TopN || sort instanceof Limit;
    }
