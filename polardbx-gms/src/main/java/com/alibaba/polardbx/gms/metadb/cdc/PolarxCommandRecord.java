 ...
 **/
public class PolarxCommandRecord implements SystemTableRecord {
    public final static int COMMAND_STATUS_INITIAL = 0;
    public final static int COMMAND_STATUS_SUCCESS = 1;
    public final static int COMMAND_STATUS_FAIL = 2;
    ...
    @Override
    public PolarxCommandRecord fill(ResultSet rs) throws SQLException {
