...
public class StmtExecutePacket extends CommandPacket {
    ...
    public byte flags;                                                       // (1)
    /**
     * in mysql protocol, iteration_count is always 1
     * in PolarDB-X protocol, iteration_count is used for batch prepare
     */
    ...
    public void readAfterStmtId(MySQLMessage mm, int num_params, Map<Integer, Object> skipParams,
        ...
        valuesArr = new ArrayList<>(num_params * iteration_count);
