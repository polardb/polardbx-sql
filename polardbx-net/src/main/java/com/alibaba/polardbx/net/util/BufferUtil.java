...
public class BufferUtil {
    ...
    // 将LengthEncoded Integer的二进制值类型写入bugffer
    // LengthEncoded Integer的定义
    // 可以参考：http://dev.mysql.com/doc/internals/en/integer.html#packet-Protocol::LengthEncodedInteger
