...
public interface ErrorCode {
    ...
    // transaction managing command
    int ERR_TRANS = 5001;
    int ERR_TRANS_UNSUPPORTED = 5002;
    int ERR_TRANS_LOG = 5003;
    int ERR_TRANS_NOT_FOUND = 5004;
    int ERR_TRANS_FINISHED = 5005;
    ...
    int ER_CANT_CHANGE_TX_ISOLATION = 1568;
    int XA_RBDEADLOCK = 1614;
    int ER_VARIABLE_IS_READONLY = 1621;
    int ER_SET_TABLE_READONLY = 1630;
}
