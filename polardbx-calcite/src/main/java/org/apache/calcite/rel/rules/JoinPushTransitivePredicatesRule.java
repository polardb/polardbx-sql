...
public class JoinPushTransitivePredicatesRule extends RelOptRule {
  ...
  public boolean matches(RelOptRuleCall call) {
    ...
    final Set<RexTableInputRef.RelTableRef> tableReferences = mq.getTableReferences(join);
  ...
  @Override public void onMatch(RelOptRuleCall call) {
    ...
    /**
     *  case:
     *  select * from select_base_two_multi_db_one_tb a where a.pk not in  ( select b.varchar_test from select_base_four_multi_db_one_tb b ) and a.pk < 20
     *  we can't transitive Predicate pk < 20 to anti side(select_base_four_multi_db_one_tb)
     **/
