 ...
 * @author luoyanxin
 */
public class CreateTableGroup extends DDL {
    protected CreateTableGroup(RelOptCluster cluster, RelTraitSet traits,
    ...
    @Override
    public CreateTableGroup copy(RelTraitSet traitSet, List<RelNode> inputs) {
        assert traitSet.containsIfApplicable(Convention.NONE);
        return new CreateTableGroup(this.getCluster(), traitSet, ((CreateTableGroup) inputs.get(0)).getAst(), rowType);
    }
}
