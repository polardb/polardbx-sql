...
public abstract class RelDataTypeSystemImpl implements RelDataTypeSystem {
  public int getMaxScale(SqlTypeName typeName) {
    ...
    case TIME_WITH_LOCAL_TIME_ZONE:
      return SqlTypeName.MAX_TIME_FRACTIONAL_SECOND_SCALE;
    default:
      return -1;
    }
  }
  ...
  @Override public int getDefaultPrecision(SqlTypeName typeName) {
    ...
    case BINARY:
      /* Modified by eric.fy
       * Note: MySQL treats plain 'CHAR' in two behaviours: in CREATE TABLE statements 'CHAR' means 'CHAR(1)',
       * while in normal queries 'CHAR' means unlimited length aka. PRECISION_NOT_SPECIFIED.
       * Here we prefer the later one.
       * e.g.
       *   SELECT CAST('hello world' AS CHAR CHARACTER SET utf8);
       * should returns 'hello world' instead of 'h'
       */
    case VARCHAR:
    case VARBINARY:
  ...
  @Override public int getMaxPrecision(SqlTypeName typeName) {
    ...
    case TIME:
    case TIME_WITH_LOCAL_TIME_ZONE:
      return SqlTypeName.MAX_TIME_PRECISION;
    case DATETIME:
    case TIMESTAMP:
    case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
