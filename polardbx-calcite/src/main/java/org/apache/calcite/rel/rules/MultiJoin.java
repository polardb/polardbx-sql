 ...
 */
public class MultiJoin extends AbstractRelNode {
  //~ Instance fields --------------------------------------------------------

  protected final List<RelNode> inputs;
  protected RexNode joinFilter; // not final for propagate
  ...
  public RelWriter explainTermsForDisplay(RelWriter pw) {
    ...
    joinFilter.accept(visitor);
    return pw.item(RelDrdsWriter.REL_NAME, "MultiJoin")
        .item("innerJoinConditions", visitor.toSqlString())
        .item("outerJoinConditions", outerJoinConds)
        .item("projFields", projFieldObjects);
  }
}
