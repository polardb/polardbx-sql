...
public class AlterTableGroupDropPartition extends DDL {
    ...
    public static AlterTableGroupDropPartition create(RelOptCluster cluster, RelTraitSet traits, SqlDdl ddl,
                                                      RelDataType rowType,
                                                      String tableGroupName) {

        return new AlterTableGroupDropPartition(cluster, traits, ddl, rowType, tableGroupName);
    }

    @Override
    public AlterTableGroupDropPartition copy(
