...
public class AlterTableGroupMergePartition extends AlterTableGroupDdl {
    ...
    public static AlterTableGroupMergePartition create(RelOptCluster cluster, RelTraitSet traits, SqlDdl ddl,
                                                       RelDataType rowType, Map<SqlNode, RexNode> partBoundExprInfo,
                                                       String tableGroupName) {

        return new AlterTableGroupMergePartition(cluster, traits, ddl, rowType, partBoundExprInfo, tableGroupName);
    }

    @Override
    public AlterTableGroupMergePartition copy(
        RelTraitSet traitSet, List<RelNode> inputs) {
        assert traitSet.containsIfApplicable(Convention.NONE);
        return new AlterTableGroupMergePartition(this.getCluster(), traitSet, this.ddl, rowType, partBoundExprInfo, tableGroupName);
    }
