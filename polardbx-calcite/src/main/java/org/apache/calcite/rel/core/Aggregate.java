...
//      assert typeMatchesInferred(aggCall, Litmus.THROW);
  ...
  private boolean isPredicate(RelNode input, int index) {
    ...
    return (type.getSqlTypeName() == SqlTypeName.BOOLEAN || type.getSqlTypeName() == SqlTypeName.BIGINT);
//        && !type.isNullable();
  }
  ...
  @Override public RelOptCost computeSelfCost(RelOptPlanner planner,
    ...
    return planner.getCostFactory().makeCost(rowCount * multiplier, 0, 0,0, 0);
  }
