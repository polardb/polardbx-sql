 ...
 * </ul>
 */
public class LogicalJoin extends Join {
  //~ Instance fields --------------------------------------------------------
  ...
  protected boolean isConditionPushed = false;
  ...
  public static LogicalJoin create(RelNode left, RelNode right,
      ...
      return create(left, right, condition, variablesSet, joinType, semiJoinDone, systemFieldList, new SqlNodeList(SqlParserPos.ZERO));
  }
  ...
  @Override public LogicalJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
    ...
    LogicalJoin logicalJoin = new LogicalJoin(getCluster(),
        ...
        variablesSet, joinType, semiJoinDone, systemFieldList, hints);
    logicalJoin.setConditionPushed(isConditionPushed);
    logicalJoin.getJoinReorderContext().copyFrom(this.getJoinReorderContext());
    return logicalJoin;
  }
  ...
  public RelWriter explainTermsForDisplay(RelWriter pw) {
    pw.item(RelDrdsWriter.REL_NAME, "LogicalJoin");
  ...
  public boolean isConditionPushed() {
    return isConditionPushed;
  }

  public void setConditionPushed(boolean conditionPushed) {
    isConditionPushed = conditionPushed;
  }
