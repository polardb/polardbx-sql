 ...
 */
public class SqlExplain extends SqlCall implements SqlHint {
  ...
  protected SqlNodeList hints = new SqlNodeList(SqlParserPos.ZERO);
  protected boolean simpleExplain;
  ...
  public boolean isSimpleExplain() {
    return simpleExplain;
  }

  public void setSimpleExplain(boolean simpleExplain) {
  ...
  public SqlNode clone(SqlParserPos pos) {
    SqlExplain newExplain = (SqlExplain)super.clone(pos);
    newExplain.setSimpleExplain(isSimpleExplain());
    newExplain.setHints(getHints());
    return newExplain;
  }
