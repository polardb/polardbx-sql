 ...
 */
public class SqlDropSequence extends SqlSequence {

    private static final SqlOperator OPERATOR =
            new SqlSpecialOperator("DROP SEQUENCE", SqlKind.DROP_SEQUENCE);
     ...
     * @param pos
     */
    public SqlDropSequence(SqlCharStringLiteral seqName , SqlIdentifier tableName, String sql, SqlParserPos pos) {
