...
// [index_option] ...
public class SqlAddSpatialIndex extends SqlAddIndex {

    private static final SqlOperator OPERATOR = new SqlSpecialOperator("ADD SPATIAL INDEX", SqlKind.ADD_SPATIAL_INDEX);

    public SqlAddSpatialIndex(SqlParserPos pos, SqlIdentifier indexName, SqlIndexDefinition indexDef){
