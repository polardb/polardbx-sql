...
public abstract class SqlOperatorBinding {
  ...
  public boolean isOperandParameterized(int ordinal) {
    throw new UnsupportedOperationException();
  }

  /**
   * To determine whether an expression is constant or not.
   * NOTE: The function call like 1+2 is also considered as a constant expression.
   * @param ordinal
   * @return
   */
  public boolean isConstant(int ordinal) {
    throw new UnsupportedOperationException();
  }
