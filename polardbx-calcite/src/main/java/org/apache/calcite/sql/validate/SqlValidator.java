...
public interface SqlValidator {
  ...
  /**
   * Validates an MULTI UPDATE statement.
   *
   * @param update MULTI UPDATE statement
   */
  void validateMultiUpdate(SqlMultiUpdate update);
  ...
  /**
   * Returns the scope of an SqlPartitionBy node.
   *
   * @param node Node
   * @return Scope
   */
  SqlValidatorScope getPartitionByScope(SqlNode node);
  ...
  SqlValidatorScope getWithScope(SqlNode withItem);
    ...
    void validateCreateView(SqlCreateView sqlCreateView,SqlValidatorScope scope);
