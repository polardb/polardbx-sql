...
/**
 * @author chenmo.cm
 * @date 2018/6/12 上午10:36
 */
public class SqlShowBroadcasts extends SqlShow {

    private static final SqlSpecialOperator OPERATOR = new SqlShowBroadcastsOperator();

    public SqlShowBroadcasts(SqlParserPos pos,
    ...
    public SqlKind getShowKind() {
        return SqlKind.SHOW_BROADCASTS;
    }

    public static class SqlShowBroadcastsOperator extends SqlSpecialOperator {

        public SqlShowBroadcastsOperator(){
            super("SHOW_BROADCASTS", SqlKind.SHOW_BROADCASTS);
        }
