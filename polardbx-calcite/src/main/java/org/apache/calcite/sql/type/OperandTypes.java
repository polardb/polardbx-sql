...
public abstract class OperandTypes {
  ...
  public static final SqlSingleOperandTypeChecker NUMERIC_STRING =
  ...
  public static final FamilyOperandTypeChecker STRING_INTERVAL =
            family(SqlTypeFamily.STRING, SqlTypeFamily.DATETIME_INTERVAL);
  public static final FamilyOperandTypeChecker INTERVAL_STRING =
  ...
  public static final SqlSingleOperandTypeChecker DATEADD =
  ...
  public static final SqlSingleOperandTypeChecker POSITIVE_INTEGER_LITERAL =
      new FamilyOperandTypeChecker(ImmutableList.of(SqlTypeFamily.INTEGER),
        ...
        public boolean checkSingleOperandType(
          ...
          final Integer value =  arg.getValueAs(Integer.class);
          ...
          if (value.compareTo(Integer.MAX_VALUE) > 0) {
            if (throwOnFailure) {
              throw callBinding.newError(
  ...
  public static final SqlSingleOperandTypeChecker ANY_OR_ANY_ANY = OperandTypes.or(ANY, ANY_ANY);
  ...
  public static final SqlSingleOperandTypeChecker PLUS_OPERATOR =
      OperandTypes.or(NUMERIC_NUMERIC, INTERVAL_SAME_SAME, DATETIME_INTERVAL,
          INTERVAL_DATETIME, STRING_INTERVAL, INTERVAL_STRING, NUMERIC_STRING, STRING_NUMERIC, STRING_STRING, ANY_ANY);

  /**
   * Type checking strategy for the "*" operator
   */
  public static final SqlSingleOperandTypeChecker MULTIPLY_OPERATOR =
      OperandTypes.or(NUMERIC_NUMERIC, INTERVAL_NUMERIC, NUMERIC_INTERVAL, STRING_INTERVAL, INTERVAL_STRING,
           NUMERIC_STRING, STRING_NUMERIC, STRING_STRING);

  /**
   * Type checking strategy for the "/" operator
   */
  public static final SqlSingleOperandTypeChecker DIVISION_OPERATOR =
      OperandTypes.or(NUMERIC_NUMERIC, INTERVAL_NUMERIC, STRING_INTERVAL, INTERVAL_STRING,
            NUMERIC_STRING, STRING_NUMERIC, STRING_STRING, ANY_ANY); //Temporary solution for operand type check

  /**
   * Type checking strategy for the "%" operator
   */
  public static final SqlSingleOperandTypeChecker MYSQL_MOD_OPERATOR =
      OperandTypes.or(NUMERIC_NUMERIC, INTERVAL_NUMERIC, STRING_INTERVAL, INTERVAL_STRING,
          NUMERIC_STRING, STRING_NUMERIC, STRING_STRING, ANY_ANY);


  public static final SqlSingleOperandTypeChecker MINUS_OPERATOR =
      // TODO:  compatibility check
      OperandTypes.or(NUMERIC_NUMERIC, INTERVAL_SAME_SAME, DATETIME_INTERVAL, STRING_INTERVAL, INTERVAL_STRING,
            NUMERIC_STRING, STRING_NUMERIC, STRING_STRING);
   ...
   * 单个数值参数或者两个数值参数
   */
  public static final SqlSingleOperandTypeChecker NUMERIC_OR_NUMERIC_NUMERIC = OperandTypes.or(NUMERIC, NUMERIC_NUMERIC);

  /**
   * 3个任意参数
   */
  public static final SqlSingleOperandTypeChecker ANY_ANY_ANY = family(SqlTypeFamily.ANY, SqlTypeFamily.ANY, SqlTypeFamily.ANY);

  /**
   * 两个任意参数或三个任意参数
   */
  public static final SqlSingleOperandTypeChecker ANY_ANY_OR_ANY_ANY_ANY = OperandTypes.or(ANY_ANY, ANY_ANY_ANY);
