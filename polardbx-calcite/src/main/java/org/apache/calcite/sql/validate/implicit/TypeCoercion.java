...
public interface TypeCoercion {
   ...
   */
  boolean caseWhenCoercion(SqlCallBinding binding, RelDataType targetType);

  /**
   * Coerce all operands on coercion positions to target type.
   */
  boolean targetTypeCoercion(SqlCallBinding callBinding, RelDataType targetType, int... positions);
