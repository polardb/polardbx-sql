...
import org.apache.calcite.sql.type.OperandsTypeChecking;
...
public class SqlBetweenOperator extends SqlInfixOperator {
  ...
  public SqlBetweenOperator(Flag flag, boolean negated) {
    super(negated ? NOT_BETWEEN_NAMES : BETWEEN_NAMES, negated ? SqlKind.NOT_BETWEEN : SqlKind.BETWEEN, 28,
        null, InferTypes.FIRST_KNOWN, OperandTypes.VARIADIC);
    this.flag = flag;
      ...
      ExplicitOperatorBinding newOpBinding =
          new ExplicitOperatorBinding(
              ...
              collectOperandTypes(
                  ...
                  callBinding.getCall()));
      return ReturnTypes.BIGINT_NULLABLE.inferReturnType(
          newOpBinding);
    } else {
      return ReturnTypes.BIGINT_NULLABLE.inferReturnType(opBinding);
    }
  }
  ...
  public void unparse(
    ...
    /** CoronaDB: Do not output the Flag keyword. */
