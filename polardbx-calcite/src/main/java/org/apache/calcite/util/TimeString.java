...
public class TimeString implements Comparable<TimeString> {
    ...
    public static TimeString fromObject(Object o) {
        if (o instanceof TimeString) {
            ...
            cal.setTimeInMillis(((Time) o).getTime());
            return fromCalendarFields(cal);
        } else {
            GeneralUtil.nestedException("can't cast " + o.getClass().getName() + " to TimeString");
        }
        return null;
    }
    ...
    public Calendar toCalendar() {
        return Util.calendar(getMillisOfDay(), TimeZone.getDefault());
    }
