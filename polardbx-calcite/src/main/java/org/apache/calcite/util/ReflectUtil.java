...
public abstract class ReflectUtil {
  ...
  public static <R extends ReflectiveVisitor, E> ReflectiveVisitDispatcher<R, E> createDispatcher(
    ...
    return new ReflectiveVisitDispatcher<R, E>() {
      final Map<List<Object>, Method> map = Collections.synchronizedMap(new HashMap<>());

      public Method lookupVisitMethod(
          Class<? extends ReflectiveVisitor> visitorClass,
  ...
  public static <E, T> MethodDispatcher<T> createMethodDispatcher(
      ...
      final Class<? extends ReflectiveVisitor> visitorClazz,
    ...
    final ReflectiveVisitDispatcher<? extends ReflectiveVisitor, E>
        dispatcher = createDispatcher(visitorClazz, arg0Clazz);
    return new MethodDispatcher<T>() {
      public T invoke(ReflectiveVisitor visitor, Object... args) {
        Method method = lookupMethod(visitor, args[0]);
        try {
      ...
      private Method lookupMethod(final ReflectiveVisitor visitor, final Object arg0) {
  ...
  public interface MethodDispatcher<T> {
     ...
     */
    T invoke(ReflectiveVisitor visitor, Object... args);
  }
}
