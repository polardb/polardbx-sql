...
public class RelStructuredTypeFlattener implements ReflectiveVisitor {
  ...
  //~ Inner Classes ----------------------------------------------------------
  private static final ReflectiveVisitDispatcher<RelStructuredTypeFlattener, RelNode> dispatcher =
    ReflectUtil.createDispatcher(RelStructuredTypeFlattener.class, RelNode.class);
    ...
    @Override public RexNode visitFieldAccess(RexFieldAccess fieldAccess) {
      ...
      for (;;) {
        ...
        if (refExp instanceof RexInputRef) {
          ...
          refExp = rexBuilder.makeCorrel(refType, ((RexCorrelVariable) refExp).getId());
